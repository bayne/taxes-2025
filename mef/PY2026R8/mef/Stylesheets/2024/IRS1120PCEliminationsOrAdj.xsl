	...
	<xsl:template match="/">
		...
		<html lang="EN-US">
			...
			Form <span class="styFormNumber" style="font-size:18pt">1120-PC</span>
					...
					For calendar year 2024, or tax year beginning   
					  ...
					  <a style="text-decoration:none;color:black;" href="http://www.irs.gov/form1120pc" title="Link to irs.gov">
						...
						<div class="styTYBox" style="width:30mm;height:18mm;">
							...
							<div class="styTY" style="height:11mm;">20<span class="styTYColor">24</span>
							</div>
						</div>
					</div>
					<!--Return Header End -->
					...
					<!-- Header Line A 1 -->
					<div style="width:187mm;float:left;clear:left;height:38.5mm;">
						<div style="width:33.3mm;height:2mm;float:left;clear:left">
							...
							<div class="styComType" style="width:33.3mm;border-bottom:0px;border-right-width: 1px;">
								...
								<div class="styGenericDiv" style="height:7mm;padding-top:2mm;">
									<input type="checkbox" aria-label="IRS1120PCConsolidated return (attach Form 851)" class="styCkbox">
							...
							<div class="styComType" style="width:33.3mm;border-bottom:0px;border-right-width: 1px;height:8.3mm;">
								...
								<div class="styGenericDiv" style="height:7mm;padding-top:2mm;">
									<input type="checkbox" aria-label="Indicates life-nonlife consolidated returns are included" class="styCkbox">
										<xsl:call-template name="PopulateCheckbox">
							...
							<br/>
							<!-- Header Line A 3 -->
							<div class="styComType" style="width:33.3mm;border-bottom:1px solid black;border-right-width: 1px;height:18.5mm;">
							...
							<xsl:call-template name="SetFormLinkInline">
								...
								<div class="styGenericDiv" style="height:9mm;padding-top:2mm;">
									<input type="checkbox" aria-label="Indicates Schedule M-3 is attached" class="styCkbox">
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" select="$Form1120PCData/ScheduleM3Form1120PCInd"/>
			  ...
			  Please<br/> print<br/> or<br/> type
							...
							<div class="styNameAddr" style="width:94.5mm;height:14mm;border-left-width:1px;padding-left:2mm;">
                ...
                <!-- Address -->
							...
							<div class="styNameAddr" style="border-bottom-width:0px;width:90mm;border-left-width:1px;padding-left:2mm;height:16mm;">
			...
			<div class="styNBB" style="border-right:1px solid black;height:4.5mm;">
			  ...
			  <span style="width:2px;height:1mm"/>
					...
					<div class="styBB" style="width:187mm;border-bottom:2px solid black;border-top:1px solid black;">
						<div class="styIRS1120PCVTImageBox" style="height:142.6mm;padding-top:14mm;border-bottom:1px solid black;">
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			...
			<!-- line 15 -->
			<div class="styGenericDiv" style="width:181mm;">
				<div class="styLNLeftNumBox" style="height:4.3mm;">15</div>
				<div class="styLNDesc" style="width:133mm;height:4.3mm;">
				...
				<div style="width:40mm;float:right;clear:none;">   	       
					<div class="styLNRightNumBox" style="height:4.3mm;">15</div>
					<div class="styLNAmountBox" style="height:4.3mm;">
					  <xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$Form1120PCData/TotalTaxAmt"/>
					  </xsl:call-template>
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			...
			<div style="width:181mm;border-bottom:1px solid black;">
			  <div style="float:left;clear:none;">
			  	...
			  	<div class="styLNDesc" style="width:133mm;height:4.3mm;"><b>Total payments and refundable credits.</b> Combine lines 16a through 16z
					<!--Dotted Line-->
					<div class="styDotLn" style="float:right;">.........</div> 
      	        </div> 
			  </div>
				<div style="width:40mm;float:right;clear:none;">
					<div class="styLNRightNumBox" style="height:4.3mm;width:8mm;border-bottom:0px solid black;">17</div>
			...
			<div style="width:181mm; margin-left: 5mm;">
			  <div style="float:left;clear:none;">
				...
				<div class="styLNDesc" style="width:133mm;height:4.3mm;">
				  ...
				  <input type="checkbox" aria-label="Indicates Form 2220 is attached" class="styCkbox">
					<xsl:call-template name="PopulateCheckbox">
					  <xsl:with-param name="TargetNode" select="$Form1120PCData/Form2220AttachedInd"/>
			...
			<div class="styGenericDiv" style="width:181mm; margin-left: 5mm;">
			  ...
			  <div class="styLNDesc" style="width:133mm;height:4.3mm;">
				<span style="float:left"> <b>Amount owed.</b> If line 17 is smaller than the total of lines 15 and 18, enter amount owed
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">.....</div>
			  </div>
			...
			<div class="styGenericDiv" style="width:181mm; margin-left: 5mm;">
			  ...
			  <div class="styLNDesc" style="width:133mm;height:4.3mm;">
			    <span style="float:left"> <b>Overpayment.</b> If line 17 is larger than the total of lines 15 and 18, enter amount overpaid
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">....</div>
			  </div>
			...
			<div class="styGenericDiv" style="width:181mm; margin-left: 5mm;">
			  <div style="width:141mm;float:left;clear:none;">
				...
				<div class="styLNDesc" style="width:79mm;height:4.3mm;">Enter amount from line 20: 
				  <span class="styBoldText">Credited to 2025 estimated tax</span><!--
				  <span style="width:2px"/>				  -->
				</div>
				<div class="styGenericDiv" style="width:36mm;height:4.3mm; padding-top:1mm; border-bottom:1px solid black;">
				  <xsl:call-template name="PopulateAmount">
			  ...
			  <div style="width:40mm;float:right;clear:none;">
				<div class="styLNRightNumBoxNBB" style="height:4.3mm;">21</div>
		  ...
		  <!--END of Tax Computation and Payments Section-->
                  ...
                  <input class="styCkbox" aria-label="May the IRS discuss this return with the preparer shown below? Yes" type="checkbox" name="Checkbox" id="dummyidyes" style="width:3mm;">
										<xsl:call-template name="PopulateReturnHeaderOfficer">
                      ...
                      Yes
									...
									<input class="styCkbox" aria-label="May the IRS discuss this return with the preparer shown below? No" type="checkbox" name="Checkbox" id="dummyidno" style="width:2.5mm;">
										<xsl:call-template name="PopulateReturnHeaderOfficer">
              ...
              Form <span class="styBoldText" style="font-size:8pt;">1120-PC</span> (2024)
            </div>
					</div>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;float:none;">
						<div style="float:left;">Form 1120-PC (2024)<span style="width:146mm;"/>
						</div>
		...
		<div class="styGenericDiv">
		  ...
		  <div class="styLNDesc" style="width:167mm;height:4.5mm;">			
			...
			<span class="styDotLn" style="float:right;">......
				<input type="checkbox" class="styCkbox" aria-label="NOL Forgo Carryback">
				  <xsl:call-template name="PopulateCheckbox">
...
<!--								<span class="styUnderlineAmount" style="float:right;width:20mm; "/>	-->			
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1120-PC</span> (2024)
					...
					<table class="styLeftOverTbl">
						...
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Line 15z - Backup Withholding Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1120PCData/OtherCreditsPaymentsAmt/@backupWithholdingTypeCd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">Line 15z - Backup Withholding Amount</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1120PCData/OtherCreditsPaymentsAmt/@backupWithholdingAmt"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
