        ...
        <span style="width: 18mm;border-bottom:1px solid black;">
          ...
          <span style="width: 18mm;border-bottom:1px solid black;">
			...
			<div class="styTYBox" style="width:30mm;height:18mm;">
			  ...
			  <div class="styTY" style="height:11mm;">20<span class="styTYColor">24</span></div>
			</div>
		  </div>
		  <!--Return Header End -->
...
<!--				  <span style="width:2mm;"/>-->
			...
			<div class="styGenericDiv" style="width:181mm; margin-left: 5mm;">
			  <div style="width:141mm;float:left;clear:none;">
				...
				<div class="styGenericDiv" style="width:36mm;height:4.3mm; padding-top:0.5mm; border-bottom:1px solid black; padding-right: 1mm; text-align: right;">
				  <xsl:call-template name="PopulateAmount">
