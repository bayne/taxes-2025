			...
			<body class="styBodyClass" style="width:187mm;">
				<form name="Form1120ScheduleD">
					...
					<div class="styTYBox" style="width:30mm;height:19mm;border-left-width:.5mm;">
						...
						<div class="styTY" style="padding-top:1mm;height:14mm;">20<span class="styTYColor">24</span></div>
					</div>
				</div>
				<!-- END FORM HEADER -->
				<!-- BEGIN TAXPAYER INFO -->
          ...
          <!-- Qurstion in qualified opportunity fund -->
					<div style="width:187mm;border-style: solid; border-color: black;border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px;">
						...
						<xsl:with-param name="TargetNode" select="$FormData/DisposeInvestmentQOFInd"/>
									...
									<input type="checkbox" aria-label="Dispose Investment QOF Yes Indicator" class="styCkbox" name="Checkbox">
						...
						<xsl:with-param name="TargetNode" select="$FormData/DisposeInvestmentQOFInd"/>
							...
							<input type="checkbox" aria-label="Dispose Investment QOF No Indicator" class="styCkbox" name="Checkbox">
					...
					<div class="IRS1120ScheduleD_styFormFooter">
						...
						<span style="width:42mm;text-align:right;float:right;">Schedule D (Form 1120) 2024</span>
					</div>
					<!-- BEGIN FOOTER -->
				</form>
