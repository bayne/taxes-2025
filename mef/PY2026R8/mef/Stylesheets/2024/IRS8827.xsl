        ...
        <body class="styBodyClass" style="width:187mm;">
          <form name="Form8827">
            ...
            <!--L1-->
              ...
              <div class="styLNDesc" style="width:138.75mm;">Alternative minimum tax (AMT) for prior year. Enter the amount from line 13 of the corporation’s prior year Form 4626
                <!--Dotted Line-->
            ...
            <div style="width:187mm;">
              ...
              <div class="styLNDesc" style="width:138.75mm;"><b>Current year minimum tax credit.</b> Enter the smaller of line 10 or line 3 here and on Form 1120, Schedule J, Part 1, line 5d (or the applicable line of your return). Check if the corporation had a section 382 ownership change or has pre-acquisition excess credits, : (a)  
								    <span style="padding-left:1mm;">
										<input type="checkbox" aria-label="Section 383 Indicator" class="styCkbox">
									...
									<span style="padding-left:1mm;">
										<input type="checkbox" aria-label="Section 384 Indicator" class="styCkbox">
											<xsl:call-template name="PopulateCheckbox">
