        ...
        <span style="width: 18mm;border-bottom:1px solid black;">
          ...
          <span style="width: 18mm;border-bottom:1px solid black;">
			...
			<div class="styTYBox" style="width:30mm;height:18mm;">
			  ...
			  <div class="styTY" style="height:11mm;">20<span class="styTYColor">25</span></div>
			</div>
		  </div>
		  <!--Return Header End -->
		  ...
		  <div style="width:187mm;float:left;clear:left;height:33.3mm;">
			<div style="width:33.3mm;height:2mm;float:left;clear:left;height:31.3mm;">
			...
			<div class="styEINDateAssets" style="width:48mm;height:15mm;border-bottom-width:0px;">
			  ...
			  Check applicable box(es) if an election has been made under section(s):
			  <br/>
...
-->			<xsl:call-template name="SetFormLinkInline">
		...
		<div class="styBB" style="width:187mm;border-bottom:2px solid black;border-top:1px solid black;">
			...
			<div style="width:2mm;height:35mm;"/>
				<img src="{$ImagePath}/1120PC_TaxComputation.gif" alt="Vertical Tax Computation and Payments" style="width:4.8mm;border-right:.5px solid black;background-color:plum;"/>
		  </div>
		  <!--line 1 -->
  ...
  <div style="width:187mm;">
	...
	<div style="width:187mm;">
	  ...
	  <div style="width:187mm;">
		...
		<div style="float:right;">Page <span style="font-weight:bold;font-size:8pt;">10</span></div>
	  </div>
	  <!-- END Page 10 Header -->
