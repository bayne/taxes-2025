	...
	<xsl:template match="/">
		...
		<html lang="EN-US">
			...
			Form <span class="styFormNumber" style="font-size:18pt">1120-PC</span>
					...
					<!-- Header Line A 1 -->
					<div style="width:187mm;float:left;clear:left;height:33.3mm;">
						<div style="width:33.3mm;height:2mm;float:left;clear:left">
							...
							<div class="styComType" style="width:33.3mm;border-bottom:0px;border-right-width: 1px;height:8.3mm;">
								...
								<div class="styGenericDiv" style="height:7mm;padding-top:2mm;">
									<input type="checkbox" aria-label="Life non-life consolidated return" class="styCkbox">
										<xsl:call-template name="PopulateCheckbox">
							...
							<br/>
							<!-- Header Line A 3 -->
							<div class="styComType" style="width:33.3mm;border-bottom:1px solid black;border-right-width: 1px;height:13mm;">
							...
							<xsl:call-template name="SetFormLinkInline">
								...
								<div class="styGenericDiv" style="height:9mm;padding-top:2mm;">
									<input type="checkbox" aria-label="Schedule M-3 form 1120 PC is attached" class="styCkbox">
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" select="$Form1120PCData/ScheduleM3Form1120PCInd"/>
						...
						<div class="styLblNameAddr" style="width:105mm;height:auto;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;">
							<div class="styNameAddr" style="width:104.5mm;height:8.5mm;border-left-width:0px;padding-left:2mm;">Name<br/>
							...
							<div class="styNameAddr" style="width:79mm;height:8.5mm;border-left-width:0px;padding-left:2mm;">
								...
								<xsl:if test="$Form1120PCData/USAddress/AddressLine2Txt!=''">
									<xsl:call-template name="PopulateText">
							...
							<div class="styNameAddr" style="width:25.7mm;border-bottom-width:1px;height:8.5mm;padding-left:2mm;border-left-width:1px;">
								Room or suite no.<br/>
								<span class="stySmallText" style="padding-left:2mm;">
									<!-- Insert code for Room or suite no once added to schema. -->
								</span>
							</div>		
							<div class="styNameAddr" style="width:26mm;border-bottom-width:0px;border-left-width:0px;padding-left:2mm;height:16mm;">
								City or town
								<br/>
								<!-- USA city -->
							...
							<div class="styNameAddr" style="width:26mm;border-bottom-width:0px;border-left-width:1px;padding-left:2mm;height:16mm;">
								State or Province
								<br/>
			                <!-- USA State -->
              ...
              To do this, we use the EINChanged parameter PopulateReturnHeaderFiler.-->
						...
						<div class="styEINDateAssets" style="width:48mm;height:15mm;border-bottom-width:0px;">
							<span class="styBoldText" style="padding-right:1mm">D </span>Check applicable box(es) if an election has been made under section(s):
							<br/>
							<input type="checkbox" aria-label="Election made under Section 831(b)" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
							...
							<input type="checkbox" aria-label="Election made under section 953(c)(3)(C)" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
							...
							<!--D Check boxes -->
							<br/>
						<input type="checkbox" aria-label="Election made under section 953(d)" class="styCkbox">
							<xsl:call-template name="PopulateCheckbox">
			...
			<div class="styNBB" style="border-right:1px solid black;height:4.5mm;">
			  ...
			  Check if: <span style="width:1mm;"/>
								...
								<span style="width:3px;"/>
								<input type="checkbox" aria-label="Indicates this is a final return" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
								...
								<span style="width:3px;"/>
								<input type="checkbox" aria-label="Indicates this is a Name Change" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
								...
								<span style="width:3px;"/>
								<input type="checkbox" aria-label="Indicates this return has an address change" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
								...
								<span style="width:3px;"/>
								<input type="checkbox" aria-label="Indicates this return has an Amended Return" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
			  ...
			  <span style="width:2px;height:1mm"/>
					...
					<div class="styBB" style="width:187mm;border-bottom:2px solid black;border-top:1px solid black;">
						<div class="styIRS1120PCVTImageBox" style="height:159.9mm;padding-top:14mm;border-bottom:1px solid black;">
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			<div style="width:141mm;float:left;clear:none;">
			  <div class="styLNLeftNumBoxSD" style="height:4.3mm;padding-left: 2.25mm;">3a</div>
			  <div class="styLNDesc" style="width:92mm;height:4.3mm;">
				<span style="float:left">Income tax (see instructions)
                  <xsl:call-template name="LinkToLeftoverDataTableInline">
				    <xsl:with-param name="Desc">Line 3a - Form 8978 Indicator</xsl:with-param>
				    <xsl:with-param name="TargetNode" select="$Form1120PCData/IncomeTaxAmt/@form8978Cd"/>
			      </xsl:call-template>
			      <xsl:call-template name="LinkToLeftoverDataTableInline">
				    <xsl:with-param name="Desc">Line 3a - Form 8978 Amount</xsl:with-param>
			  ...
			  <div class="styLNRightNumBox" style="height:4.3mm;">3a</div>
			  <div class="styLNAmountBox" style="height:4.3mm;">
				<xsl:call-template name="PopulateAmount">
			...
			<div style="width:141mm;float:left;clear:none;">
			  ...
			  <div class="styLNDesc" style="width:92mm;height:4.3mm;">
				<span style="float:left">Section 1291 tax from Form 8621
				  ...
				  <xsl:call-template name="SetFormLinkInline">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/Section1291Amt"/>
				  </xsl:call-template>
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">...........</div>
			  </div>
			  <div class="styLNRightNumBox" style="height:4.3mm;">3b</div>
			  <div class="styLNAmountBox" style="height:4.3mm;">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/Section1291Amt"/>
				</xsl:call-template>
			...
			<div style="width:141mm;float:left;clear:none;">
			  ...
			  <div class="styLNDesc" style="width:92mm;height:4.3mm;">
				<span style="float:left">Additional tax under section 197(f)
                  <!-- Form to Form Link (Push Pin) -->
				  <xsl:call-template name="SetFormLinkInline">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/Section197Amt"/>
				  </xsl:call-template>
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">...........</div>
			  </div>
			  <div class="styLNRightNumBox" style="height:4.3mm;">3c</div>
			  <div class="styLNAmountBox" style="height:4.3mm;">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/Section197Amt"/>
				</xsl:call-template>
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			<div style="width:141mm;float:left;clear:none;">
			  ...
			  <div class="styLNRightNumBox" style="height:4.3mm;">3d</div>
			  <div class="styLNAmountBox" style="height:4.3mm;">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/BaseErosionMinimumTaxAmt"/>
				</xsl:call-template>
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			<div style="width:141mm;float:left;clear:none;">
			  ...
			  <div class="styLNDesc" style="width:92mm;height:4.3mm;">
				<span style="float:left">Amount from Form 4255, Part 1, line 3, column (q)
                  <!-- Form to Form Link (Push Pin) -->
				  <xsl:call-template name="SetFormLinkInline">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/TotalChapter1TaxAmt"/>
				  </xsl:call-template>
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">.....</div>
			  </div>
			  <div class="styLNRightNumBox" style="height:4.3mm;">3e</div>
			  <div class="styLNAmountBox" style="height:4.3mm;">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/TotalChapter1TaxAmt"/>
				</xsl:call-template>
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			<div style="width:141mm;float:left;clear:none;">
			  <div class="styLNLeftNumBoxSD" style="height:4.3mm;padding-left: 4.25mm;">z</div>
			  <div class="styLNDesc" style="width:92mm;height:4.3mm;">
				<span style="float:left">Other chapter 1 tax
                  <!-- Form to Form Link (Push Pin) -->
				  <xsl:call-template name="SetFormLinkInline">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/OtherChapter1TaxAmt"/>
				  </xsl:call-template>
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">...............</div>
			  </div>
			  <div class="styLNRightNumBox" style="height:4.3mm;">3z</div>
			  <div class="styLNAmountBox" style="height:4.3mm;">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/OtherChapter1TaxAmt"/>
				</xsl:call-template>
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			...
			<div class="styLNDesc" style="width:133mm;height:4.3mm;">
			  <span style="float:left;">Total income tax. Add lines 3a through 3z.
                <!-- Form to Form Link (Push Pin)-->
				<xsl:call-template name="SetFormLinkInline">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/TotalIncomeTaxAmt"/>
				</xsl:call-template>
			  </span>
			  <!--Dotted Line-->
			  <div class="styDotLn" style="float:right;padding-right:1mm;">................</div>
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			...
			<div class="styLNDesc" style="width:133mm;height:4.3mm;">
			  <span style="float:left;">Corporate alternative minimum tax from Form 4626, Part II, line 13 (attach Form 4626)
                <!-- Form to Form Link (Push Pin)-->
				<xsl:call-template name="SetFormLinkInline">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/CorpAlternativeMinimumTaxAmt"/>
				</xsl:call-template>
			  </span>
			  <!--Dotted Line-->
			  <div class="styDotLn" style="float:right;padding-right:1mm;">....</div>
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			...
			<div style="width:40mm;float:right;clear;none;">
			  ...
			  <div class="styLNAmountBox" style="height:4.3mm;">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/IncmTxBaseErosionTxCAMTSumAmt"/>
				</xsl:call-template>
			  </div>
			</div>
		  </div>
		  <!-- line 8a -->
                  ...
                  <!-- Form to Form Link (Push Pin) -->
						...
						<!-- line 9 -->
						<div class="styGenericDiv" style="width:181mm;">
							<div class="styLNLeftNumBoxSD" style="height:4.3mm;padding-left: 2.25mm">9</div>
							<div class="styLNDesc" style="width:133mm;height:4.3mm;">
								<span style="float:left;padding-right:1mm;">
									<b>Total credits.</b> Add lines 8a through 8e
				</span>
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="Desc">Line 9 - Form 8978 Indicator</xsl:with-param>
									<xsl:with-param name="TargetNode" select="$Form1120PCData/TotalCreditAmt/@form8978Cd"/>
								</xsl:call-template>
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="Desc">Line 9 - Form 8978 Amount</xsl:with-param>
						...
						<div class="styGenericDiv" style="width:181mm;">
							...
							<div class="styLNDesc" style="width:133mm;height:4.3mm;">
								<span style="float:left">Subtract line 9 from line 7</span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">........................</div>
							</div>
							<div style="width:40mm;float:right;clear:none;">
			...
			<!-- line 13a TotalIncreaseInTaxAmt -->
		  <div class="styGenericDiv" style="width:181mm;">
			<div style="width:141mm;float:left;clear:none;">
			  <div class="styLNLeftNumBoxSD" style="height:4.3mm;padding-left: 1mm;">13a</div>
			  <div class="styLNDesc" style="width:92mm;height:4.3mm;">
				<span style="float:left">Amount from Form 4255, Part 1, line 3, column (r)
                  <!-- Form to Form Link (Push Pin) -->
				  <xsl:call-template name="SetFormLinkInline">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/TotalNonChapter1TaxAmt"/>
				  </xsl:call-template>
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">....</div>
			  </div>
			  <div class="styLNRightNumBox" style="height:4.3mm;">13a</div>
			  <div class="styLNAmountBox" style="height:4.3mm;">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/TotalNonChapter1TaxAmt"/>
				</xsl:call-template>
			...
			<div style="width:141mm;float:left;clear:none;">
			  ...
			  <div class="styLNDesc" style="width:92mm;height:4.3mm;">
				<span style="float:left"> Recapture of low-income housing credit (attach Form 8611)
                  <!-- Form to Form Link (Push Pin) -->
				  <xsl:call-template name="SetFormLinkInline">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/RecaptureTaxAmt"/>
				  </xsl:call-template>
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">..</div>
			  </div>
			  <div class="styLNRightNumBox" style="height:4.3mm;">13b</div>
			  <div class="styLNAmountBox" style="height:4.3mm;">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/RecaptureTaxAmt"/>
				</xsl:call-template>
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			<div style="width:141mm;float:left;clear:none;">
			  ...
			  <div class="styLNRightNumBox" style="height:4.3mm;">13z</div>
			  <div class="styLNAmountBox" style="height:4.3mm;">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/OtherTaxesAmt"/>
				</xsl:call-template>
    		...
    		<!-- line 14 TotalOtherTaxesAndInterestAmt-->
			<div class="styGenericDiv" style="width:181mm;">
			  <div class="styLNLeftNumBox" style="height:4.3mm;">14</div>
			  <div class="styLNDesc" style="width:133mm;height:4.3mm;">
				<span style="float:left">  <b>Total.</b> Add lines 13a through 13z
                  <!-- Form to Form Link (Push Pin)-->
				  <xsl:call-template name="SetFormLinkInline">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/TotalOtherTaxesAndInterestAmt"/>
				  </xsl:call-template>
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">....................</div>
			...
			<div class="styGenericDiv" style="width:181mm;">
				...
				<div class="styLNDesc" style="width:133mm;height:4.3mm;">
				<span style="float:left"><b>Total tax.</b> Add lines 10, 11, 12 and 14 
                  <!-- Form to Form Link (Push Pin) -->
				  <xsl:call-template name="SetFormLinkInline">
			...
			<!-- line 15b -->
			<div class="styGenericDiv" style="width:181mm;">
				<div class="styLNLeftNumBox" style="height:4.3mm;padding-left:4mm">b</div>
				<div class="styLNDesc" style="width:133mm;height:4.3mm;">
				<span style="float:left">Net section 1062 tax liability due this year, from Form 1062
				</span>
					<!--Dotted Line-->
					<span class="styDotLn" style="float:right;">..............</span> 
      	        </div>   
				<div style="width:40mm;float:right;clear:none;">   	       
					<div class="styLNRightNumBox" style="height:4.3mm;">15b</div>
					<div class="styLNAmountBox" style="height:4.3mm;">
					  <xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$Form1120PCData/FirstInstallmentSect1062TaxAmt"/>
					  </xsl:call-template>
					</div>
				</div>
			</div>			
			<!-- line 16a PriorYearOverpaymentCreditAmt-->
		  <div class="styGenericDiv" style="width:181mm;">
			<div style="width:141mm;float:left;clear:none;">
			  <div class="styLNLeftNumBoxSD" style="height:4.3mm;padding-left:1mm;">16a</div>
			  <div class="styLNDesc" style="width:92mm;height:4.3mm;">Preceding year’s overpayment credited to current year
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">.....</div>
      	        </div>  
			  <div class="styLNRightNumBox" style="height:4.3mm;">16a</div>
			  <div class="styLNAmountBox" style="height:4.3mm;">
				<xsl:call-template name="PopulateAmount">
			...
			<!-- line 16b EstimatedTaxPaymentsAmt-->
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="width:141mm;float:left; clear:none;">
				<div class="styLNLeftNumBox" style="height:4.3mm;padding-left: 4.25mm;">b</div>
				<div class="styLNDesc" style="width:92mm;height:4.3mm;"> Current year’s estimated tax payments (see instructions)
					<!--Dotted Line-->
					<div class="styDotLn" style="float:right;">....</div> 
				</div>
				<div class="styLNRightNumBox" style="height:4.3mm;">16b</div>
				<div class="styLNAmountBox" style="height:4.3mm;">
				  <xsl:call-template name="PopulateAmount">
			...
			<!-- line 16C OverpaymentOfEstimatedTaxAmt-->
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="width:141mm;float:left;clear:none;">
				<div class="styLNLeftNumBox" style="height:4.3mm;padding-left: 4.25mm;">c</div>
				<div class="styLNDesc" style="width:92mm;height:4.3mm;">Current year’s refund applied for on Form 4466
				  <!-- Form to Form Link (Push Pin) -->
				  <xsl:call-template name="SetFormLinkInline">
				...
				<div class="styLNRightNumBox" style="height:4.3mm;">16c</div>
				<div class="styLNAmountBox" style="height:4.3mm;">
			...
			<!-- line 16d TaxPaidForm7004Amt -->
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="width:141mm;float:left; clear:none;">
				  <div class="styLNLeftLtrBox" style="height:4.3mm;padding-left: 4.25mm;">d</div>
				  <div class="styLNDesc" style="width:92mm;height:4.3mm;">
					<span style="float:left">Tax deposited with Form 7004</span>
					<!--Dotted Line-->
					<div class="styDotLn" style="float:right;padding-right:1mm;">.............</div>
				  </div>
				  <div class="styLNRightNumBox" style="height:4.3mm;">16d</div>
			...
			<!-- line 16e ReciprocalTaxPaidSect835dAmt -->
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="width:141mm;float:left;clear:none;">
				<div class="styLNLeftLtrBox" style="height:4.3mm;padding-left: 4.25mm;">e</div>
				<div class="styLNDesc" style="width:92mm;height:4.3mm;">
					<span style="float:left">Credit by reciprocal for tax paid by attorney-in-fact under section 835(d)</span>					
      	        </div>      	       
				<div class="styLNRightNumBox" style="height:4.3mm;">16e</div>
				<div class="styLNAmountBox" style="height:4.3mm;width:31.5mm;">
				  <xsl:call-template name="PopulateAmount">
			...
			<!-- line 16f ElectivePaymentAmt-->
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="width:141mm;float:left;clear:none;">
				<div class="styLNLeftLtrBox" style="height:4.3mm;padding-left: 4.25mm;">f</div>
				<div class="styLNDesc" style="width:92mm;height:4.3mm;">
					<span style="float:left;padding-right:1mm">Elective payment election amount from Form 3800 </span>		
					<!-- Form to Form Link (Push Pin) -->
					  <xsl:call-template name="SetFormLinkInline">
						<xsl:with-param name="TargetNode" select="$Form1120PCData/ElectivePaymentAmt"/>
					  </xsl:call-template>	
					  	<!--Dotted Line-->
						<div class="styDotLn" style="float:right;">.....</div> 		
      	        </div>      	       
				<div class="styLNRightNumBox" style="height:4.3mm;">16f</div>
				<div class="styLNAmountBox" style="height:4.3mm;width:31.5mm;">
				  <xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/ElectivePaymentAmt"/>
				  </xsl:call-template>
			...
			<!-- line 16g Total liability section 1062 tax-->
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="width:141mm;float:left;clear:none;">
				<div class="styLNLeftLtrBox" style="height:6mm;padding-left: 4.25mm;">g</div>
				<div class="styLNDesc" style="width:92mm;height:6mm;">
					<div style="float:left;padding-right:1mm;width:92mm">Net tax liability deferred on sale of farmland. Enter amount from Form</div>		
					<div style="float:left;padding-right:1mm;width:92mm">1062		
					  	<!--Dotted Line-->
						<span class="styDotLn" style="float:right;">....................</span>
					</div> 		
      	        </div>      	       
				<div class="styLNRightNumBox" style="height:6mm;padding-top:2mm;">16g</div>
				<div class="styLNAmountBox" style="height:6mm;width:31.5mm;padding-top:2mm;">
				  <xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/TotalLiabilitySect1062TaxAmt"/>
				  </xsl:call-template>
				</div>
			  </div>				
			  <div style="width:40mm;float:left;clear:none;">
					<div class="styLNRightNumBoxNBB" style="background-color:lightgrey;height:6mm;"/>
					<div class="styLNAmountBoxNBB" style="height:6mm;width:32mm;background-color:lightgrey;"/>
			  </div>
			</div>
			<!-- line 16z OtherCreditsPaymentsAmt -->
			<div class="styGenericDiv"  style="width:181mm;">
			  <div style="width:141mm;float:left;clear:none;">
				  <div class="styLNLeftLtrBox" style="height:4.3mm;padding-left: 4.25mm;">z</div>
				  <div class="styLNDesc" style="width:92mm;height:4.3mm;">
					...
					<!-- Form to Form Link (Push Pin) -->
					  ...
					  <xsl:call-template name="LinkToLeftoverDataTableInline">
						<xsl:with-param name="Desc">Line 16z - Backup Withholding Indicator</xsl:with-param>
						<xsl:with-param name="TargetNode" select="$Form1120PCData/OtherCreditsPaymentsAmt/@backupWithholdingTypeCd"/>
					  </xsl:call-template>
					  <xsl:call-template name="LinkToLeftoverDataTableInline">
						<xsl:with-param name="Desc">Line 16z - Backup Withholding Amount</xsl:with-param>
				...
				<div class="styLNRightNumBox" style="height:4.3mm;">16z</div>
				<div class="styLNAmountBox" style="height:4.3mm;width:31.5mm;">
				  <xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/OtherCreditsPaymentsAmt"/>
				  </xsl:call-template>
			...
			<!-- line 17 TotalPaymentsAndCreditsAmt -->
			<div style="width:181mm;border-bottom:1px solid black;">
			  <div style="float:left;clear:none;">
			  	<div class="styLNLeftNumBox" style="height:7mm;">17</div>
			  	<div class="styLNDesc" style="width:133mm;height:7mm;">
					<b>Total payments, refundable credits and section 1062 net tax liability</b>
					<br/>
					Combine lines 16a through 16z
					<!--Dotted Line-->
					<div class="styDotLn" style="float:right;">.......................</div> 
      	        </div> 
			  </div>
				<div style="width:40mm;float:right;clear:none;">
					<div class="styLNRightNumBox" style="height:7mm;width:8mm;border-bottom:0px solid black;padding-top:3.4mm;">17</div>
					<div class="styLNAmountBox" style="height:7mm;width:32mm;border-bottom:0px solid black;padding-top:3.4mm;">
					  <xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$Form1120PCData/TotalPaymentsAndCreditsAmt"/>
					  </xsl:call-template>
					</div>
				</div>
			</div>
			<!-- line18 EsPenaltyAmt-->
			<div style="width:181mm; margin-left: 5mm;">
			  <div style="float:left;clear:none;">
			...
			<!-- line19 BalanceDueAmt -->
			<div class="styGenericDiv" style="width:181mm; margin-left: 5mm;">
			  <div class="styLNLeftNumBox" style="height:4.3mm;">19</div>
			  <div class="styLNDesc" style="width:133mm;height:4.3mm;">
				<span style="float:left"> <b>Amount owed.</b> If line 17 is smaller than the total of lines 15a, 15b and 18, enter amount owed
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">...</div>
			  </div>
			  <div style="width:40mm;float:right;clear:none;">
				<div class="styLNRightNumBox" style="height:4.3mm;">19</div>
				<div class="styLNAmountBox" style="height:4.3mm;">
				  <xsl:call-template name="PopulateAmount">
			...
			<!-- line20 OverpaymentAmt -->
			<div class="styGenericDiv" style="width:181mm; margin-left: 5mm;">
			  <div class="styLNLeftNumBox" style="height:4.3mm;">20</div>
			  <div class="styLNDesc" style="width:133mm;height:4.3mm;">
			    <span style="float:left"> <b>Overpayment.</b> If line 17 is larger than the total of lines 15a, 15b and 18, enter amount overpaid
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">..</div>
			  </div>
			  <div style="width:40mm;float:right;clear:none; ">
				<div class="styLNRightNumBox" style="height:4.3mm;">20</div>
				<div class="styLNAmountBox" style="height:4.3mm;">
				  <xsl:call-template name="PopulateAmount">
			...
			<!-- line 21 AppliedToEsTaxAmt -->
			<div class="styGenericDiv" style="width:181mm; margin-left: 5mm;">
			  <div style="width:141mm;float:left;clear:none;">
				<div class="styLNLeftNumBox" style="height:4.3mm;">21</div>
				<div class="styLNDesc" style="width:84mm;height:4.3mm;">Enter amount from line 20: 
				  <span class="styBoldText"> a Credited to 2026 estimated tax</span><!--
				  <span style="width:2px"/>				  -->
				</div>
				<div class="styGenericDiv" style="width:31mm;height:4.3mm; padding-top:0.5mm; border-bottom:1px solid black; padding-right: 1mm; text-align: right;">
				  <xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/OverpaymentSection/AppliedToEsTaxAmt"/>
				  </xsl:call-template>
				</div>
				<div class="styLNDesc" style="width:18mm;height:4.3mm;">
				  <span class="styBoldText">b Refunded</span>
				  <span style="width:.5mm;"/>
				  <!-- Form to Form Link Push Pin-->
				  <xsl:call-template name="SetFormLinkInline">
			  ...
			  <div style="width:40mm;float:right;clear:none;">
				<div class="styLNRightNumBox" style="height:4.3mm;">21b</div>
				<div class="styLNAmountBox" style="height:4.3mm;">
				  <xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/OverpaymentSection/RefundAmt"/>
				  </xsl:call-template>
			...
			<!--Line 21c, 21d-->
				<div class="styGenericDiv" style="width:181mm;">
					...
					<div class="styLNDesc" style="width:133mm;height:4mm;">
						...
						<span class="styLNCtrNumBox" style="width:34mm;border-top-width:1px;padding-top:0mm;padding-bottom:0mm;font-weight:normal">
							<!--<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$Form1120PCData/DirectDepositGrp/RoutingTransitNum"/>
							</xsl:call-template>-->
						</span>
						...
						<input type="checkbox" class="styCkboxNM" aria-label="Checking Account">
							<!--<xsl:call-template name="PopulateCheckbox">
								<xsl:with-param name="TargetNode" select="$Form1120PCData/DirectDepositGrp/CheckingAccountInd"/>
								<xsl:with-param name="BackupName">IRS1120PCCheckingAccountInd</xsl:with-param>
							</xsl:call-template>-->
						</input>
						<label>
							<xsl:call-template name="PopulateLabel">	
						...
						<input type="checkbox" class="styCkboxNM" aria-label="Savings Account" style="margin-left:4mm;">
							<!--<xsl:call-template name="PopulateCheckbox">
								<xsl:with-param name="TargetNode" select="$Form1120PCData/DirectDepositGrp/SavingsAccountInd"/>
								<xsl:with-param name="BackupName">IRS1120PCSavingsAccountInd</xsl:with-param>
							</xsl:call-template>-->
						</input>
						<label>
							<xsl:call-template name="PopulateLabel">
					...
					<div style="width:40mm;float:right;clear:none;">
						...
						<div class="styLNAmountBoxNBB" style="height:4.5mm;width:31.5mm;background-color:lightgrey;"/>
					</div>
				</div>
				<!-- Line 21e -->
				<div style="width:181mm;height:5mm;float:left;">
					...
					<div class="styLNDesc" style="width:133mm;height:4.5mm;">
						...
						<span class="styLNCtrNumBox" style="width:44mm;border-top-width:1px;padding-top:0mm;padding-bottom:0mm;font-weight:normal">
							<!--<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$Form1120PCData/DirectDepositGrp/DepositorAccountNum"/>
							</xsl:call-template>-->
						</span>
					</div>
					<div style="width:40mm;float:right;clear:none;">
						<div class="styLNRightNumBoxNBB" style="background-color:lightgrey;height:5mm;"/>
						<div class="styLNAmountBoxNBB" style="height:5mm;width:31.5mm;background-color:lightgrey;"/>
					</div>
				</div>
			</div>
		  </div>
		  <!--END of Tax Computation and Payments Section-->
                  ...
                  <input class="styCkbox" aria-label="Discuss with third party? Yes" type="checkbox" name="Checkbox" id="dummyidyes" style="width:3mm;">
										<xsl:call-template name="PopulateReturnHeaderOfficer">
                      ...
                      Yes
									...
									<input class="styCkbox" aria-label="Discuss with third party? No" type="checkbox" name="Checkbox" id="dummyidno" style="width:2.5mm;">
										<xsl:call-template name="PopulateReturnHeaderOfficer">
				...
				Use Only
				  ...
				  Preparer's signature
					...
					Check 
					<input class="styCkbox" aria-label="self employed indicator" type="checkbox" style="width:4mm;">
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="$RtnHdrData/PreparerPersonGrp/SelfEmployedInd"/>
              ...
              Form <span class="styBoldText" style="font-size:8pt;">1120-PC</span> (2025)
            </div>
					</div>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;float:none;">
						<div style="float:left;">Form 1120-PC (2025)<span style="width:146mm;"/>
						</div>
...
-->
  ...
  <div class="styBB" style="width:187mm;height:auto;border-bottom-width:1px;float:left;clear:left;">
	<!-- Left Hand Side-->
	<div class="styLblNameAddr" style="height:auto;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px;border-right-width: 0px;">
	  ...
	  <div>
		...
		<div class="styLNDesc" style="width:167mm;height:4.5mm;">
		  ...
		  <span style="width:3px;"/>
		  <!-- Check Box-->
		  <input type="checkbox" class="styCkbox" aria-label="Cash">
			<xsl:call-template name="PopulateCheckbox">
	  ...
	  <div>
		...
		<div class="styLNDesc" style="width:167mm;height:4.5mm;">
		  ...
		  <span style="width:3px;"/>
		  <!-- Check Box-->
		  <input type="checkbox" class="styCkbox" aria-label="Accrual">
			<xsl:call-template name="PopulateCheckbox">
	  ...
	  <div>
		...
		<div class="styLNDesc" style="width:167mm;height:4.5mm;">
		  ...
		  <span style="width:3px;"/>
		  <!-- Check Box-->
		  <input type="checkbox" class="styCkbox" aria-label="Other (specify)">
			<xsl:call-template name="PopulateCheckbox">
		...
		<!-- Shading Cell-->
		<div class="styShadingCell" style="width:6mm;height:6.5mm;padding-bottom:1mm;"/>
		<div class="styShadingCellRB" style="width:6mm;height:6.5mm;padding-bottom:1mm;border-left-width:0px;"/>
	  </div>
	  <!-- Schedule I, Line 2-->
	  ...
	  <div class="styGenericDiv">
		...
		<div class="styLNDesc" style="width:167mm;height:4.5mm;">
		  ...
		  <span style="width:3px;"/>
		  <!-- Check Box-->
		  <input type="checkbox" class="styCkbox" aria-label="Mutual">
			<xsl:call-template name="PopulateCheckbox">
	  ...
	  <div class="styGenericDiv">
		...
		<div class="styLNDesc" style="width:167mm;height:4.5mm;">
		  ...
		  <span style="width:3px;"/>
		  <!-- Check Box-->
		  <input type="checkbox" class="styCkbox" aria-label="Stock">
			<xsl:call-template name="PopulateCheckbox">
	  ...
	  <div class="styGenericDiv">
		...
		<div class="styLNDesc" style="width:167mm;height:auto;">		  
		  At the end of the tax year, did the corporation own, directly or indirectly, 50% or more of the voting stock
		  of a domestic corporation? (For rules of attribution, see section 267(c).) 
		  <!--Dotted Line -->
		  <span class="styDotLn" style="float:right;padding-right:1mm;">.........................</span>
		</div>
		<!-- Shading Cell-->
		<div class="styShadingCell" style="width:6mm;height:3mm;"/>
		<div class="styShadingCellRB" style="width:6mm;height:3mm;border-left-width:0px;"/>
...
<!--		<div class="styShadingCell" style="width:6mm;height:4.5mm;"/>
	  ...
	  <div class="styGenericDiv">
		...
		<div class="styLNDesc" style="width:167mm;height:4.5mm;">
		  ...
		  <span style="width:40mm;background-color:none;">
			<!--<span style="width:3px;"/>-->
			<span style="width:95mm;border-bottom:1px solid black;background-color:none;">
			  <xsl:call-template name="PopulateText">
	  ...
	  <div class="styGenericDiv">
		...
		<div class="styLNDesc" style="width:167mm;height:7.5mm;padding-top:4;">
		  <span style="float:left">
	  ...
	  <div class="styGenericDiv">
		...
		<div class="styLNDesc" style="width:167mm;height:7.5mm;padding-top:4;">
		  <span style="float:left">
			...
			<b>(b)</b> the total value of all classes of stock of the corporation?
			<!--Dotted Line -->
		    <span class="styDotLn" style="float:right;padding-right:1mm;">.....</span>		   
		  </span>
		</div>
	  ...
	  <div class="styGenericDiv" style="height:25mm;">
		<div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left: 2.25mm"></div>
		<div class="styLNDesc" style="width:167mm;height:4.5mm;">
		  ...
		  <!-- Shading Cell-->
		  <div class="styShadingCell" style="width:6mm;height:25mm;"/>
		  <div class="styShadingCellRB" style="width:6mm;height:25mm;border-left-width:0px;"/>
		</div>		
		<!-- Schedule I, Line 7a-->
		<div class="styGenericDiv">
		...
		<div class="styGenericDiv">
		  ...
		  <div class="styLNDesc" style="width:135mm;height:4.5mm;">
			<span style="float:left">
			  <b>(1)</b> For the current tax year: 
			</span>
			<!--Dotted Line -->
		    <span class="styDotLn" style="float:right;padding-right:1mm;">.....................$</span>	
		  </div>
		  <div class="styIRS1120PCBBText" style="width:31mm;height:4.5mm;text-align:right;margin-right: 1mm">
		    <xsl:call-template name="PopulateAmount">
		...
		<div class="styGenericDiv">
		  ...
		  <div class="styLNDesc" style="width:135mm;height:4.5mm;">
			<span style="float:left">
			  <b>(2)</b> For the previous tax year: 
			</span>
			<!--Dotted Line -->
		    <span class="styDotLn" style="float:right;padding-right:1mm;">.....................$</span>	
		  </div>
		  <div class="styIRS1120PCBBText" style="width:31mm;text-align:right;margin-right: 1mm">
			<xsl:call-template name="PopulateAmount">
		...
		<div class="styGenericDiv">
		  ...
		  <div class="styLNDesc" style="width:167mm;height:4.5mm;">
			...
			<span style="width:2mm;background-color:none;"/>
				<span>
					<!--Dotted Line -->
					<span class="styDotLn" style="padding-right:1mm;">......$</span>
					<span style="float:right;width:31mm;border-bottom:1px solid black;background-color:none;text-align:right;">
					  <xsl:call-template name="PopulateAmount">
		...
		<div class="styGenericDiv">
		  <div class="styLNLeftNumBox" style="height:4.5mm;padding-left: 2.25mm">10</div>
		  <div class="styLNDesc" style="width:167mm;height:4.5mm;">			
			If the corporation has an NOL for the tax year and is electing to forgo the carryback period, check here
			<!--Dotted Line -->
			<span class="styDotLn" style="float:right;">......
				<input type="checkbox" class="styCkbox" aria-label="Corporation NOL and forgo carryback">
				  <xsl:call-template name="PopulateCheckbox">
		...
		<div class="styGenericDiv">
		  ...
		  <div class="styLNDesc" style="width:167mm;height:4.5mm;">
			<span style="float:left">
			  ...
			  the statement required by Regulations section 1.1502-21(b)(3) must be attached 
			  <xsl:call-template name="SetFormLinkInline">
				<xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/NOLForegoCarrybackInd"/>
			  </xsl:call-template>
		...
		<div class="styGenericDiv">
			...
			<div class="styLNDesc" style="width:167mm;height:4.5mm;">			  
			  Enter the available NOL carryover from prior tax years. <br/>(Don't reduce it by any deduction on line 36b, Schedule A.)
			  <span>
			  <!--Dotted Line -->
			  <span class="styDotLn" style="padding-right:1mm;padding-left:2mm; ">.............$</span>	
			  <span style="float:right;padding-left:3mm;width:30mm;border-bottom:1px solid black;text-align:right;">
				<xsl:call-template name="PopulateAmount">
		...
		<!-- Schedule I, Line 13-->
		  <div class="styGenericDiv">
			...
			<div class="styLNDesc" style="width:167mm;height:7.5mm;">
				If the corporation is a Blue Cross or Blue Shield organization described in section 833(c)(2), or other
				organization described in section 833(c)(3), did it meet the medical loss ratio (MLR) requirements of section 833(c)(5)?
				<!--Dotted Line -->
				<span class="styDotLn" style="float:right;padding-right:1mm;">............</span>
			</div>
			<!-- Shading Cell-->
...
<!-- Schedule I, Line 13a -->
	<div class="styGenericDiv">
	  ...
	  <div class="styLNDesc" style="width:167mm;height:8.5mm;">
		<div style="width:130mm;clear:none;">
			<b>a</b> Section 833(c)(5)  
	...
	<div class="styGenericDiv">
	  <div class="styLNLeftNumBoxSD" style="height:8.5mm;font-size:6pt;padding-left: 4.25mm"></div>
	  <div class="styLNDesc" style="width:167mm;height:8.5mm;">
		<div style="width:130mm;float:left;clear:none;">
			<b>b</b> Section 833(c)(5) 
  ...
  <div class="styLNDesc" style="width:167mm;height:8.5mm;">
	<div style="width:130mm;float:left;clear:none;">
		<b>c</b> Section 833(c)(5) 
		<span style="width:5mm;"/>MLR
		<span class="styDotLn" style="float:right;padding-right:2mm;">.......................
		</span>				
	</div>
	<div style="width:33mm;float:right;clear:none;">
	  <!--<span style="padding-top:2mm;">-->
		% <span style="width:1mm;"/>
		<span style="width:27.5mm;padding-bottom:.5mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;text-align:right;">
		  <xsl:call-template name="PopulateText">
	...
	<div>			
		<!-- Schedule I, Line 14-->
		  <div class="styGenericDiv">
			...
			<div class="styLNDesc" style="width:167mm;height:18mm;">
				If the corporation is a small company as defined in section 831(b)(2) and elects under section 831(b)(2)(A)(iii) to be taxed on taxable investment income: <br/><br/>
		  ...
		  <div class="styGenericDiv">
			...
			<div class="styLNDesc" style="width:167mm;height:4.5mm;padding-top:2mm;">
				<b>b</b> If the answer to (a) is no, does the corporation satisfy the diversification requirements of section 831(b)(2)(B)(i)(II)?
				   <!--Dotted Line -->
				  <span class="styDotLn" style="float:right;padding-right:1mm;">..</span>
		  </div>
		  <!-- Shading Cell-->
			<div class="styShadingCell" style="width:6mm;height:2mm;"/>
			<div class="styShadingCellRB" style="width:6mm;height:2mm;border-left-width:0px;"/>
		...
		<!-- Schedule I, Line 15-->
		  <div class="styGenericDiv">
			<div class="styLNLeftNumBox" style="height:4.5mm;padding-left: 2.25mm;padding-top:2.5mm;">15</div>
			<div class="styLNDesc" style="width:167mm;height:13mm;padding-top:3.5mm;">
		...
		<!-- Schedule I, Line 16 -->
		<div class="styGenericDiv">
		  <div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left: 6mm"></div>
		  <div class="styLNDesc" style="width:135mm;height:6mm;">	
			<span style="float:left">
			  If “Yes,” enter the total amount of the disallowed deductions
			</span>
			<!--Dotted Line -->
		    <span class="styDotLn" style="padding-left:5mm;padding-right:1mm;">............$</span>	
		  </div>
		  <div class="styIRS1120PCBBText" style="width:31mm;text-align:right;margin-right: 1mm">
			<xsl:call-template name="PopulateAmount">
...
<!--			<div class="styShadingCell" style="width:6mm;height:2mm;"/>
		  ...
		  <div class="styGenericDiv">
			...
			<div class="styLNDesc" style="width:167mm;height:7.5mm;">
				Is the corporation required to file Form 8990, Limitation on Business Interest Expense Under Section 163(j), to calculate the amount of deductible business interest (see instructions)?
				<xsl:call-template name="SetFormLinkInline">
	    ...
	    <!-- Schedule I, Line 19-->
		  <div class="styGenericDiv">
			<div class="styLNLeftNumBox" style="height:4.5mm;padding-left: 2.25mm;">19</div>
			<div class="styLNDesc" style="width:167mm;height:4.5mm;">
				Is the corporation a member of a controlled group? If “Yes,” attach Schedule O (Form 1120). See instructions
				<xsl:call-template name="SetFormLinkInline">
					<xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/MemberOfControlledGroupInd"/>
				</xsl:call-template>
							<!--Dotted Line -->
		    <span class="styDotLn" style="float:right;padding-right:1mm;">...</span>	
			</div>
		...
		<!-- Schedule I, Line 20-->
		  <div class="styGenericDiv">
			<div class="styLNLeftNumBox" style="height:4.5mm;padding-left: 2.25mm">20</div>
			<div class="styLNDesc" style="width:167mm;height:12mm;">
				Corporate Alternative Minimum Tax: <br/><br/>
				<span style="float:left;"><b>a</b> Was the corporation an applicable corporation under section 59(k)(1) in any prior tax year ?
									  <!--Dotted Line -->
					  <span class="styDotLn" style="float:right;padding-left:2mm;padding-right:1mm;">...........</span>
				<br/> If “Yes,” go to question 20b. If “No,” skip to question 20c.
				</span>				   
			</div>
			<!-- Shading Cell-->
			<div class="styShadingCell" style="width:6mm;height:7mm;"/>
			<div class="styShadingCellRB" style="width:6mm;height:7mm;border-left-width:0px;"/>
			<div class="styIRS1120PCLNYesNoBox" style="border-right-width:0px;height:4.5mm;">
			  <span style="font-weight:normal;">
				<xsl:call-template name="PopulateYesBoxText">
				  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/ApplicableCorpSect59k1PYInd"/>
				</xsl:call-template>
			  </span>
			</div>
			<div class="styIRS1120PCLNYesNoBoxRB" style="height:4.5mm;">
			...
			<div class="styShadingCellRB" style="width:6mm;height:4mm;border-left-width:0px;"/>
		  </div>		
		  <div class="styGenericDiv">
			<div class="styLNLeftNumBox" style="height:4.5mm;padding-left: 2.25mm;"></div>
			<div class="styLNDesc" style="width:167mm;height:12mm;padding-top:2mm;">
				<b>b</b> Is the corporation an applicable corporation under section 59(k)(1) in the current tax year because the corporation was an
applicable corporation in the prior tax year?
				   <!--Dotted Line -->
				  <span class="styDotLn" style="float:right;padding-left:2mm;padding-right:1mm;">.........................</span>
					<br/> If "Yes," complete and attach Form 4626. 				
					<xsl:call-template name="SetFormLinkInline">
					<xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/ApplicableCorpSect59k1CYInd"/>
				</xsl:call-template>If "No," continue to question 20c.
		  </div>
		  <!-- Shading Cell-->
			<div class="styShadingCell" style="width:6mm;height:5mm;"/>
			<div class="styShadingCellRB" style="width:6mm;height:5mm;border-left-width:0px;"/>
		  ...
		  <div class="styGenericDiv">
			<div class="styLNLeftNumBox" style="height:4.5mm;padding-left: 2.25mm;"></div>
			<div class="styLNDesc" style="width:167mm;height:12mm;padding-top:2mm;">
				<b>c</b> Does the corporation meet the requirements of the safe harbor method as provided under section 59(k)(3)(A) for the current tax
year? See instructions					   
				<!--Dotted Line -->
								  <span class="styDotLn" style="float:right;padding-left:2mm;padding-right:1mm;">................................</span>
				<br/> If “No,” complete and attach Form 4626. 				
				<xsl:call-template name="SetFormLinkInline">
					<xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/SatisfyRqrSect59k3ACYInd"/>
				</xsl:call-template> If “Yes,” the corporation is not required to file Form 4626.
		  </div>
		  <!-- Shading Cell-->
			<div class="styShadingCell" style="width:6mm;height:4mm;"/>
			<div class="styShadingCellRB" style="width:6mm;height:4mm;border-left-width:0px;"/>
	...
	<!-- END Page Break and Footer for Page 8-->
      ...
      Balance Sheets per Books 
			...
			<!--Dotted Line-->
					...
					<!-- Page Break and Footer for Page 9-->
			...
			Form <span class="styBoldText" style="font-size:8pt;">1120-PC</span> (2025)
					...
					<!-- END Page Break and Footer for Page 9-->
					<!--Begin Page 10 -->
					<!-- Page 10 Header -->
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;float:none;">
						...
						<div style="float:right;">Page <span style="font-weight:bold;font-size:8pt;">10</span>
						</div>
					</div>
					<!-- END Page 9 Header -->
...
<!--									<span class="styUnderlineAmount" style="float:right;width:20mm; "/>-->
							...
							<div class="styGenericDiv" style="width:93.5mm;">
								...
								<div class="styLNDesc" style="width:53.5mm;height:4.5mm;">
									...
									<span class="styUnderlineAmount" style="width:33.5mm;text-align:rigth;">
										<xsl:call-template name="PopulateAmount">
...
<!--									<span class="styUnderlineAmount" style="float:right;width:25mm;"/>-->
				...
				<!--Dotted Line-->
							...
							<div class="styGenericDiv" style="width:93mm;">
								...
								<div class="styLNDesc" style="width:53mm;height:4.5mm;">
									<span style="float:left;">Depreciation $ </span>
									<span class="styUnderlineAmount" style="float:right;padding-right:2mm;">
										<xsl:call-template name="PopulateAmount">
...
<!--								<span class="styUnderlineAmount" style="float:right;width:20mm; "/>	-->			
		   ...
		   Analysis of Unappropriated Retained Earnings per Books
			...
			<xsl:call-template name="SetFormLinkInline">
					...
					<!-- Page Break and Footer for Page 10-->
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1120-PC</span> (2025)
					...
					<!-- END Page Break and Footer for Page 10-->
					...
					<table class="styLeftOverTbl">
						...
						<!--<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">Line 3 - Section 1291 Amount</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1120PCData/IncomeTaxAmt/@section1291Amt"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>-->
						<!--<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Line 3 - Section 197 Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1120PCData/IncomeTaxAmt/@section197Cd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">Line 3 - Section 197 Amount</xsl:with-param>
