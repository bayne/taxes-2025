				...
				<form name="IRS5471">
					...
					<div class="styBB" style="width:187mm;">										
						<div class="styFNBox" style="width:28.25mm; height: 23mm; border-bottom-width:1pt; border-right-width:1pt;">
							...
							<div class="styAgency">(Rev. December 2025)</div>
					...
					<div style="width:187mm;">
						<div class="styAddrFld" style="border-bottom-width: 0px; border-left-width:0px; border-style:solid; font-size:6pt; height:9mm; width:79mm; font-weight:normal;">
						...
						<span class="styAddrFld" style="border-bottom-width: 0px; border-left-width:0px; border-style:solid; font-size:6pt; height:9mm; width:30mm; font-weight:normal;padding-left:1mm;">
							Room or suite no. 
								<br/>
						</span>						
						<div class="styComType" style="width:78mm; height:9.3mm; float:right; clear:both; padding-left:1mm; border-top-width:1px; border-bottom-width: 0px;">
							...
							<span style="margin-left:4mm; font-size:7pt;">
								...
								<input type="checkbox" aria-label="Category Of Filer 1a Indicator" class="styCkbox">
								...
								<input type="checkbox" aria-label="Category Of Filer 1b Indicator" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471Data/CategoryOfFiler1bInd"/>
								...
								<input type="checkbox" aria-label="Category Of Filer 1c Indicator" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471Data/CategoryOfFiler1cInd"/>
								...
								<input type="checkbox" aria-label="Category Of Filer 2 Indicator" class="styCkbox" name="CategoryOfFiler2Ind">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471Data/CategoryOfFiler2Ind"/>
								...
								<input type="checkbox" aria-label="Category Of Filer 3 Indicator" class="styCkbox" name="CategoryOfFiler3Ind">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471Data/CategoryOfFiler3Ind"/>
								...
								<input type="checkbox" aria-label="Category Of Filer 4 Indicator" class="styCkbox" name="CategoryOfFiler4Ind">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471Data/CategoryOfFiler4Ind"/>
								...
								<input type="checkbox" aria-label="Category Of Filer 5a Indicator" class="styCkbox" name="CategoryOfFiler5aInd">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471Data/CategoryOfFiler5aInd"/>
								...
								<input type="checkbox" aria-label="Category Of Filer 5b Indicator" class="styCkbox" name="CategoryOfFiler5bInd">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471Data/CategoryOfFiler5bInd"/>
								...
								<input type="checkbox" aria-label="Category Of Filer 5c Indicator" class="styCkbox" name="CategoryOfFiler5cInd">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471Data/CategoryOfFiler5cInd"/>
					...
					<!--  *******************************************************************************  -->
					<div style="width:187mm;">
						<div class="styComType" style="font-size: 7pt;width:48mm; height:15mm; border-top-width:1px; border-bottom-width:0px;border-right-width:1px;padding-left:1mm;">
							City or town
							<br/>
                           	<span style="font-family:verdana, arial, sans-serif; font-size:7pt; font-weight:normal;">
						...
						<div class="styComType" style="font-size: 7pt;width:31mm; height:15mm; border-top-width:1px; border-bottom-width:0px;border-right-width:1px;padding-left:1mm;">
							State
							<br/>
							<xsl:choose>
								<xsl:when test="$IRS5471Data/PersonFilingThisReturn/USAddress">
						...
						<div class="styComType" style="font-size: 7pt;width:30mm; height:15mm; border-top-width:1px; border-bottom-width:0px;border-right-width:1px;padding-left:1mm;">
							ZIP code
							<br/>
							<span style="padding-left:2mm;"/>
							<xsl:choose>							
...
<!--										<xsl:attribute name="style">margin-left:0mm; padding-top:1mm;</xsl:attribute>	-->									
					...
					<div class="styBB" style="width:187mm; height:5mm;">
						<div style="float:left;">
							...
							<input type="checkbox" aria-label="Final Form 5471 Indicator" class="styCkbox" name="FinalForm5471Ind">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471Data/FinalForm5471Ind"/>
					...
					<div class="styBB" style="width:187mm; height:5mm;">
						<div style="float:left;">
							...
							<span style="width:8px"/>
							<input type="checkbox" aria-label="Foreign Financial Asset Indicator" class="styCkbox" name="ForeignFinancialAssetInd">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471Data/ForeignFinancialAssetInd"/>
					...
					<div class="styBB" style="width:187mm; height:5mm;">
						<div style="float:left;">
							...
							<span style="width:8px"/>
							<input type="checkbox" aria-label="Alternative Information Rev Proc 2019-40 Indicator" class="styCkbox" name="AltInformationRevProc201940Ind">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471Data/AltInformationRevProc201940Ind"/>
...
<!--								<tr>
					...
					<xsl:choose>
						<xsl:when test="($Print = $Separated)">
							...
							<table class="styTable" cellspacing="0" style="width:187mm;font-size:7pt;">
								<tr>
									<td class="styTableCell" rowspan="4" valign="top" style="width: 120mm; text-align:left;border-color:black; border-bottom:0;border-right:1">
										<b>1a</b>
								...
								<tr>
									<td class="styTableCell" valign="top" style="width: 59.5mm;height: 9.5mm;border-color:black;border-right-width: 0px;font-size:7pt;">
										<span style="width:64mm;text-align:left;padding-left:1mm;padding-bottom:5mm;">
											<b>b(3)</b>
											<span style="padding-left:1mm;font-size:7pt">Previous reference ID number(s), if any (see instructions)
                                         </span>
										</span>
										<br/>
										<br/>
										<xsl:choose>
											<xsl:when test="count($IRS5471Data/PrevForeignEntityIdGrp) = 1">
												<span style="text-align:left; width: 59.5mm; padding-left:7mm;">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="$IRS5471Data/PrevForeignEntityIdGrp/ForeignEntityReferenceIdNum"/>
													</xsl:call-template>
													<br/>
												</span>
											</xsl:when>
											<xsl:otherwise>
												<span style="text-align:left; width: 59.5mm; padding-left:7mm;">
													<xsl:call-template name="PopulateAdditionalDataTableMessage">
														<xsl:with-param name="TargetNode" select="$IRS5471Data/PrevForeignEntityIdGrp"/>
														<xsl:with-param name="ShortMessage" select=" 'false' "/>
													</xsl:call-template>
													<br/>
												</span>
						...
						<xsl:when test="($Print != $Separated)">
							<div style="width:187mm;font-size:7pt;">
								<span class="styTableCell" style="float:left;vertical-align:top;width: 110.1mm;height:35mm;text-align:left;border-right-width:0px;border-bottom-width:0px;">
									<b>1a</b>
								...
								<span class="styTableCell" style="text-align:left;width: 74mm;height:16mm;border-left-width:1px;border-right:0;border-bottom:0;">
									...
									<span class="styTableCell" style="border-top:1px solid black;padding-left:2mm;width:76mm;border-bottom-width:2px;border-left-width:1px;">
								...
								<!--<div class="styIRS5471TableContainer" id="FEIdctn" style="height:20mm;border-top-width:1px;width:76mm;padding-left:0mm;">-->
								<div class="styIRS5471TableContainer" id="FEIdctn" style="height:12mm;border-top-width:1px;width:76mm;padding-left:0mm;">							
									<xsl:call-template name="SetInitialState"/>
											...
											<xsl:choose>
												...
												<xsl:otherwise>
													<xsl:for-each select="$IRS5471Data/ForeignEntityIdentificationGrp">
														<tr>
															<td class="styTableCell" style="vertical-align:bottom;height:14mm;border-color:black;border-right:0;border-left:1px solid black;width: 73mm;padding-left:3mm;text-align:left;">
		...
		<!--  ************************************************************************************************************************************************************************  -->	
			<!--<span class="styTableCell" style="text-align:left;padding-left:2mm;height:9.5mm;border:none;border-left:1px solid black;width:76mm;">	-->	
							<span class="styTableCell" style=";border-top:1px solid black;padding-left:2mm;width:76mm;border-bottom-width:2px;border-left-width:1px;hight:10mm">
										<span style="float:left;">
											<b>b(3)</b> Previous reference ID number(s), if any 
			                            	</span>
			                            	<span style="float:left;">
									             (see instructions)
			                            	</span>
								...
								<div class="styIRS5471TableContainer" id="FEIdctn1" style="height:9mm;border-top-width:1px;width:187mm;padding-left:110.3mm">
									...
									<table class="styTable" cellspacing="0" style="font-size: 7pt;">
										<tbody>
											<xsl:choose>
												<xsl:when test="count($IRS5471Data/PrevForeignEntityIdGrp) = 0">
													<tr>
														<td class="styTableCell" style="vertical-align:bottom;height:9mm;border-color:black;border-right:0;border-left:1px solid black;">
															<span style="text-align:left;width: 73mm;">
																<br/>
												...
												<xsl:otherwise>
													<xsl:for-each select="$IRS5471Data/PrevForeignEntityIdGrp">
														<tr>
															<td class="styTableCell" style="vertical-align:bottom;height:9mm;border-color:black;border-right:0;border-left:1px solid black;width: 73mm;padding-left:3mm;text-align:left;">
																<span style="font-size:6pt;text-align:left;">
																	<xsl:call-template name="PopulateText">
																		<xsl:with-param name="TargetNode" select="ForeignEntityReferenceIdNum"/>
																	</xsl:call-template>
					...
					<table class="styTable" cellspacing="0" style="width:187mm;border-top:0px solid black;font-size: 7pt">
						<tr>
							...
							border-color: black; border-bottom-width: 0px;border-top-width:1px">
								...
								<br/>
								<div style="width:39mm;text-align:left;overflow-wrap: break-word; text-align:left;padding-top:3mm;padding-bottom:0mm">
									<xsl:call-template name="PopulateText">
									...
									<tbody>
										...
										<xsl:for-each select="$IRS5471Data/PersonWithRecordsCustody">
											<tr>
												...
												border:none;font-size:7pt;border-bottom:2pt solid black;border-left:1px solid black;">
													<xsl:if test="position()=last()">
...
<!--								<tr>
					...
					<div style="width:187mm; border-color: black; border-style: solid; border-right-width: 0px;
					 border-left-width: 0px; border-top-width: 1px; border-bottom-width: 0px;">
						...
						<div style="float:right">
							...
							Form <span class="styBoldText" style="font-size: 8pt">5471</span> (Rev. 12-2025)
						</div>
					</div>
					<!--<div class="pageEnd"/>-->
					<!--END FOOTER-->
					...
					<div class="styGenericDiv" style="width:187mm">
						<div style="float: left; clear: none">Form 5471 (Rev. 12-2025)</div>
						<div style="float:right">
...
<!--														<td class="styIRS5471TableLastCol" id="FSspcr" style=""/>-->
					...
					<div class="styBB" style="width:187mm;">
						<div class="styLNDesc" style="height:auto; width:187mm; font-size:8pt; font-style:italic;">
							<span style="font-weight:normal">
							    ...
							    Report all information in functional currency in accordance with U.S. generally accepted accounting principles (GAAP).  Also, 
							    report each amount in  U.S. dollars translated from functional currency (using GAAP translation rules).  However, 
								if the  functional currency is the U.S. dollar, complete only the U.S. Dollars column.  See instructions for special rules
								  for dollar approximate separate transactions method (DASTM) corporations. 
							</div>
					</div>
					...
					<div style="width:187mm">
						...
						<div>
							...
							<div class="styLNDesc" style="width:89mm;">
                                    Other deductions (attach statement &#8211; exclude income tax expense
							</div>
					...
					<div style="width:187mm">
						<div class="styIRS5471Img" style="height:28mm; width:12mm; padding-top:3mm; padding-left:4mm;border-bottom-width:1px; ">
						...
						<div>
							...
							<div class="styLNDesc" style="width:89mm; border-left-width:0px; border-right-width:0px; border-top-width:0px; width:89mm;">
									Current year net income or (loss) per books (combine lines 19 through 
							</div>
							<div class="styLNRightNumBox" style="background-color: lightgrey;
								 border-bottom-width: 0px">
								<span style="width: 1px"/>
						...
						<div>
							<div class="styLNLeftNumBox" style="border-bottom-width: 1px;border-bottom-color:black; border-bottom-style:solid;border-bottom"></div>
							<div class="styLNDesc" style="width:89mm; border-color:black; border-style:solid; border-left-width:0px; border-right-width:0px; border-top-width:0px; border-bottom-width: 1px;border-bottom">
									21b)
									<span class="styDotLn" style="float:right; padding-right:1mm;">....................</span>
							</div>
							<div class="styLNRightNumBox" style="border-bottom-width:1px;border-bottom">22</div>
							<div class="styLNAmountBox" style="padding-top:3.5mm; width:35mm; border-bottom-width:1px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$IRS5471CData/ForeignCYNetIncomePerBooksAmt"/>
									<xsl:with-param name="MaxSize" select="17"/>
								</xsl:call-template>
							</div>
							<div class="styLNAmountBox" style="padding-top:3.5mm; border-bottom-width: 1px; width:35mm;">
								<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm">
						...
						<div>
							...
							<div class="styLNDesc" style="width:89mm;">
								Other comprehensive income (loss), net of tax (line 23a plus line 23b 
							</div>
							<div class="styLNRightNumBox" style="background-color: lightgrey;
								 border-bottom-width: 0px">
								<span style="width: 1px"/>
					...
					<div class="styGenericDiv" style="width: 187mm">
						...
						<div class="styLNAmountBox" style="border-bottom-width: 0px; background-color: lightgrey; width: 34mm; height: 4.5mm"/>
						<div class="styLNAmountBox" style="border-bottom-width: 0px; background-color: lightgrey; width: 37mm; height: 4.5mm"/>
					</div>
					<!--  END LINE 12   -->
					...
					<div class="styGenericDiv">
						...
						<div class="styLNAmountBox" style="border-bottom-width: 0px; width: 34mm; background-color: lightgrey;"/>
						<div class="styLNAmountBox" style="border-bottom-width: 0px; width: 37mm; background-color: lightgrey;"/>
					</div>
					<!--  END LINE 20   -->
				...
				-->
					...
					<div class="styGenericDiv" style="width:187mm; height:4mm">	
							<div class="styGenericDiv" style="width:175; height:4;"> </div>
							<span style="width:12mm;float:right;height:4mm">
								<div class="styIRS5471YesNoBox" style="height:4mm; font-weight:bold; padding-top:.5mm;">Yes</div>
								<div class="styIRS5471LFNoBox" style="height:4mm; font-weight:bold; padding-top:.5mm;">No</div>
							</span>
					</div>
					...
					<div class="styGenericDiv" style="width:187mm">
						...
						<span class="styLNDesc" style="width:167mm;">
						...
						<div class="styIRS5471YesNoBoxShadingCell">
						</div>
						<div class="styIRS5471LFNoBoxShading">
						</div>
					</div>
					<div class="styGenericDiv" style="width:187mm">
						<span class="styLNDesc" style="width:167mm; margin-left:8mm;">
							<span style="float:left">
								<xsl:call-template name="SetFormLinkInline">
							...
							<div class="styIRS5471YesNoBox">
						<span>
								<xsl:call-template name="PopulateSpan">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/Owns10PctOrMoreFrgnPrtshpInd"/>
								</xsl:call-template>
								<input type="checkbox" aria-label="Owns 10 Percent Or More Foreign Partnership Indicator Yes" class="styCkbox" style="width:3mm; height:3mm">
						...
						<div class="styIRS5471LFNoBox">
						<span>
							<xsl:call-template name="PopulateSpan">
								<xsl:with-param name="TargetNode" select="$IRS5471GData/Owns10PctOrMoreFrgnPrtshpInd"/>
							</xsl:call-template>
							<input type="checkbox" aria-label="Owns 10 Percent Or More Foreign Partnership Indicator No" class="styCkbox" style="width:3mm; height:3mm">
					...
					<div class="styGenericDiv" style="width:187mm;">
						<span class="styLNDesc" style="margin-left:8mm; width:167mm">
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<span>
							...
							<input type="checkbox" aria-label="Foreign Corporation Owns Interest In Any Trust Indicator Yes" class="styCkbox" style="width:3mm; height:3mm">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/FrgnCorpOwnsInterestInTrustInd"/>
						...
						<span>
							...
							<input type="checkbox" aria-label="Foreign Corporation Owns Interest In Any Trust Indicator No" class="styCkbox" style="width:3mm; height:3mm">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/FrgnCorpOwnsInterestInTrustInd"/>
					...
					<!--   BEGIN LINE 3a of Schedule G  -->
					<div class="styGenericDiv" style="width:187mm;">
						<span class="styLNLeftNumBoxSD">3a</span>
						<span class="styLNDesc" style="width:167mm;">
						...
						<div class="styGenericDiv" style="width:187mm;">
							...
							<span>
								...
								<input type="checkbox" aria-label="Foreign Owns Any Foreign Entities Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471GData/FrgnCorpOwnsForeignEntityInd"/>
							...
							<span>
								...
								<input type="checkbox" aria-label="Foreign Owns Any Foreign Entities Indicator No" class="styCkbox" style="width:3mm; height:3mm;">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471GData/FrgnCorpOwnsForeignEntityInd"/>
...
<!--					</div>-->
					...
					<!--   END LINE 3a of Schedule G  -->
					
					<!--   BEGIN LINE 3b of Schedule G  -->
					<div class="styGenericDiv" style="width:187mm;">
						<span class="styLNLeftNumBoxSD" style="padding-left:4.5mm;">b</span>
						<span class="styLNDesc" style="width:167mm;">
								During the tax year, did the foreign corporation have one or more qualified business units as defined in section 989(a) with a 	</span>
						<div class="styIRS5471YesNoBoxShadingCell">
						</div>
						<div class="styIRS5471LFNoBoxShading">
						</div>
						...
						<div class="styGenericDiv" style="width:187mm;">
							<span class="styLNDesc" style="width:167mm; margin-left: 8mm;">
								<span style="float:left;">functional currency different than its owner? </span>
								<span class="styDotLn" style="float:right; padding-right:1mm;">..........................</span>
							</span>	
							<div class="styIRS5471YesNoBox">	
							<span>	
								<xsl:call-template name="PopulateSpan">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/OneOrMoreQBUInd"/>
								</xsl:call-template>
								<input type="checkbox" aria-label="One or more qualified business units Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471GData/OneOrMoreQBUInd"/>
										<xsl:with-param name="BackupName">OneOrMoreQBUIndYes</xsl:with-param>
									</xsl:call-template>
								</input>
							</span>	
							</div>
						...
						<span>
							...
							<input type="checkbox" aria-label="One or more qualified business units Indicator No" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/OneOrMoreQBUInd"/>
									<xsl:with-param name="BackupName">OneOrMoreQBUIndNo</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
							</div>
						...
						<div class="styGenericDiv" style="width:187mm;">
							<span class="styLNDesc" style="width:167mm; margin-left: 8mm;">
								If "Yes," enter number of Forms 8964 attached to Form 5471
								<span style="width:1mm"/>
								<span class="sty1120FItemUnderlineSM" style="border-bottom:2pt solid black;width:22mm;ext-align:left;">								
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/Form8964CFCQBUCnt"/>
								</xsl:call-template>
							</span>
							</span>
							<div class="styIRS5471YesNoBoxShadingCell">
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<div class="styIRS5471YesNoBoxShadingCell" style="height:6mm;">
						</div>
						<div class="styIRS5471LFNoBoxShading" style="height:6mm;">
						</div>
					</div>
					<div class="styGenericDiv" style="width: 187mm">
						<span class="styLNDesc" style="width: 167mm; margin-left: 8mm; height:4mm;">
							<span class="styDotLn" style="float:right;padding-right:1mm;">..........................</span>
						</span>
						<div class="styIRS5471YesNoBox">
							<xsl:call-template name="PopulateSpan">
							...
							<input type="checkbox" aria-label="Base Erosion Payment Benefit Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/BaseErosionPaymentBenefitInd"/>
						...
						<span>
							...
							<input type="checkbox" aria-label="Base Erosion Payment Benefit Indicator No" class="styCkbox" style="width: 3mm; height: 3mm">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/BaseErosionPaymentBenefitInd"/>
...
<!--					</div>-->
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<span class="styLNDesc" style="width:167mm;">
							...
							<span style="width:1mm"/>$
								<span class="sty1120FItemUnderlineSM" style="width:22mm;border-bottom:2pt solid black;">
								<xsl:call-template name="PopulateAmount">
					...
					<div class="styGenericDiv" style="width:187mm;">
							...
							<span>
								...
								<input type="checkbox" aria-label="Non deduction interest royalty under section 267A Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471GData/NondedIntRoyaltyUndSect267AInd"/>
							...
							<span>
								...
								<input type="checkbox" aria-label="Non deduction interest royalty under section 267A Indicator No" class="styCkbox" style="width:3mm; height:3mm;">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471GData/NondedIntRoyaltyUndSect267AInd"/>
			...
			<!--		</div>-->
					...
					<div class="styGenericDiv" style="width:187mm;">
						<span class="styLNLeftNumBoxSD" style="padding-left:4.5mm;">b</span>
						<span class="styLNDesc" style="width:167mm;">
							<span style="float:left">Enter the total amount of the disallowed deductions (see instructions) </span>
							<span style="padding-left:1mm">
								<!-- Ding Bat
								<img src="{$ImagePath}/5471_Bullet_Title.gif" alt="right pointing arrow"/> -->
							</span>
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:187mm;">
							...
							<span>
								...
								<input type="checkbox" aria-label="Foreign derived intangible income benefits claim Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471GData/FDIIBenefitsClaimInd"/>
							...
							<span>
								...
								<input type="checkbox" aria-label="Foreign derived intangible income benefits claim Indicator No" class="styCkbox" style="width:3mm; height:3mm;">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471GData/FDIIBenefitsClaimInd"/>
					...
					<div class="styGenericDiv" style="width:187mm;">
						<span class="styLNLeftNumBoxSD" style="padding-left:4.5mm;">b</span>
						<span class="styLNDesc" style="width:167mm; height:8mm;">
						...
						<div class="styIRS5471YesNoBoxShadingCell" style="height:8mm;">
							</div>
						<div class="styIRS5471LFNoBoxShading" style="height:8mm;">
							</div>
					</div>
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<span class="styLNDesc" style="width:167mm; height:8mm;">
							<span style="float:left">
								Enter the amount of gross receipts derived from all sales of intangible property to the foreign corporation that the filer included  
								<br/>
								<span style="float:left">in its computation of FDDEI</span>
								<span class="styDotLn" style="padding-left:1mm;">.......................</span>
								<span style="padding-left:2mm">
									<!-- Ding Bat
									<img src="{$ImagePath}/5471_Bullet_Title.gif" alt="right pointing arrow"/>-->
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<span class="styLNDesc" style="width:167mm;">
							<span style="float:left">
								...
								<xsl:call-template name="SetFormLinkInline">
									...
									<xsl:with-param name="BackupName">FrgnCorpPartcpCostShrInd</xsl:with-param>
								</xsl:call-template>
							</span>
							<span class="styDotLn" style="float:right;padding-right:1mm;">.........</span>
						</span>
						...
						<span>
							...
							<input type="checkbox" aria-label="Foreign Corporation Was Participant Yes" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/FrgnCorpPartcpCostShrInd"/>
						...
						<span>
							...
							<input type="checkbox" aria-label="Foreign Corporation Was Participant No" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/FrgnCorpPartcpCostShrInd"/>
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<span class="styLNDesc" style="width:167mm">
							<span>
								After April 25, 2014, did the foreign corporation purchase stock or securities of a shareholder of the foreign 
								<xsl:call-template name="SetFormLinkInline">
						...
						<div class="styGenericDiv" style="width: 187mm">
							...
							<span>
								...
								<input type="checkbox" aria-label="Purchase stock or securities Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471GData/PurchaseStockOrSecuritiesInd"/>
							...
							<span>
								...
								<input type="checkbox" aria-label="Purchase stock or securities Indicator No" class="styCkbox" style="width: 3mm; height: 3mm">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471GData/PurchaseStockOrSecuritiesInd"/>
...
<!--					</div>-->
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<span class="styLNDesc" style="width:167mm; height:4mm;">
							<span>
						...
						<div class="styGenericDiv" style="width:187mm">
							...
							<span>
								...
								<input type="checkbox" aria-label="Intangible property received Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471GData/IntangiblePropertyReceivedInd"/>
							...
							<span>
								...
								<input type="checkbox" aria-label="Intangible property received Indicator No" class="styCkbox" style="width: 3mm; height: 3mm">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471GData/IntangiblePropertyReceivedInd"/>
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width: 187mm">
							...
							<span>
								...
								<input type="checkbox" aria-label="Expatriated foreign subsidiary Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471GData/ExpatriatedFrgnSubsidiaryInd"/>
							...
							<span>
								...
								<input type="checkbox" aria-label="Expatriated foreign subsidiary Indicator No" class="styCkbox" style="width: 3mm; height: 3mm">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471GData/ExpatriatedFrgnSubsidiaryInd"/>
...
<!--					</div>-->
					...
					<div class="styGenericDiv" style="width: 187mm">
						...
						<span>
							...
							<input type="checkbox" aria-label="Reportable Transaction Participation Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/ReportableTransactionPrtcptInd"/>
						...
						<span>
							...
							<input type="checkbox" aria-label="Reportable Transaction Participation Indicator No" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/ReportableTransactionPrtcptInd"/>
					...
					<div class="styGenericDiv" style="width:187mm">
						...
						<span>
							...
							<input type="checkbox" aria-label="Foreign Tax Disqualified Section 901m Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/FrgnTaxDisqualifiedSec901mInd"/>
						...
						<span>
							...
							<input type="checkbox" aria-label="Foreign Tax Disqualified Section 901m Indicator No" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/FrgnTaxDisqualifiedSec901mInd"/>
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<span class="styLNDesc" style="width:175mm;width:167mm;">
					...
					<div class="styGenericDiv" style="width:187mm">
						...
						<span>
							...
							<input type="checkbox" aria-label="Foreign Tax Section 909 Indicator Yes" class="styCkbox" style="width: 3mm; height: 3mm">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/ForeignTaxSection909Ind"/>
						...
						<span>
							...
							<input type="checkbox" aria-label="Foreign Tax Section 909 Indicator No" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/ForeignTaxSection909Ind"/>
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<span>
							...
							<input type="checkbox" aria-label="Answer Yes Any Question Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/AnswerYesAnyQuestionInd"/>
						...
						<span>
							...
							<input type="checkbox" aria-label="Answer Yes Any Question Indicator No" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/AnswerYesAnyQuestionInd"/>
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<span>
							...
							<input type="checkbox" aria-label="Disallowed Interest Expense Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/DisallowedInterestExpenseInd"/>
						...
						<span>
							...
							<input type="checkbox" aria-label="Disallowed Interest Expense Indicator No" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/DisallowedInterestExpenseInd"/>
      ...
      forward to the current
					...
					<div class="styGenericDiv" style="width: 187mm">
						...
						<span>
							...
							<input type="checkbox" aria-label="Foreign Corporation Previously Disallowed Interest Expense Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/CfwdPrevDsallwIntExpenseInd"/>
						...
						<span>
							...
							<input type="checkbox" aria-label="Foreign Corporation Previously Disallowed Interest Expense Indicator No" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/CfwdPrevDsallwIntExpenseInd"/>
					...
					<div class="styGenericDiv" style="width:187mm">
						...
						<span>
							...
							<input type="checkbox" aria-label="Extraordinary Reduction Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/ExtraordinaryReductionInd"/>
						...
						<span>
							...
							<input type="checkbox" aria-label="Extraordinary Reduction Indicator No" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/ExtraordinaryReductionInd"/>
					...
					<div class="styGenericDiv" style="width:187mm">
						...
						<span>
							...
							<input type="checkbox" aria-label="Close Tax Year Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/CloseTaxYearElectionInd"/>
						...
						<span>
							...
							<input type="checkbox" aria-label="Close Tax Year Indicator No" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/CloseTaxYearElectionInd"/>
					...
					<div class="styGenericDiv" style="width:187mm">
						...
						<span>
							<xsl:call-template name="PopulateSpan">
								<xsl:with-param name="TargetNode" select="$IRS5471GData/SafeHavenRtRegsRtIntAFRInd"/>
							</xsl:call-template>
							<input type="checkbox" aria-label="Safe Haven Rate Rules of Regulations Applicable Yes" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/SafeHavenRtRegsRtIntAFRInd"/>
									<xsl:with-param name="BackupName">SafeHavenRtRegsRtIntAFRIndYes</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						</div>
						...
						<span>
							<xsl:call-template name="PopulateSpan">
								<xsl:with-param name="TargetNode" select="$IRS5471GData/SafeHavenRtRegsApplcblInd"/>
							</xsl:call-template>
							<input type="checkbox" aria-label="Safe Haven Rate Rules of Regulations Applicable No" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/SafeHavenRtRegsRtIntAFRInd"/>
									<xsl:with-param name="BackupName">SafeHavenRtRegsRtIntAFRIndNo</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						</div>
					...
					<!--   BEGIN LINE 18b of Schedule G  -->
<!--					<span  style="width:175mm;height:3mm;"></span>-->
					<div class="styGenericDiv" style="width:187mm;">
						<span class="styLNLeftNumBox" style="padding-left:4.5mm;">b</span>
						<span class="styLNDesc" style="width:167mm;">
 Did the filer have any loan to or from the foreign corporation to which the safe-haven rate rules of Regulations section 1.482-2(a)(2)(iii)(B) are applicable, and for which the filer used a rate of interest outside the relevant safe-haven range (100% to 130% of the AFR for the relevant term)? 
						</span>
						<div class="styIRS5471YesNoBoxShadingCell">
							</div>
						<div class="styIRS5471LFNoBoxShading">
					...
					<div class="styGenericDiv" style="width:187mm">
						...
						<span>
							<xsl:call-template name="PopulateSpan">
								<xsl:with-param name="TargetNode" select="$IRS5471GData/RtIntSafeHavenRegsAFRInd"/>
							</xsl:call-template>
							<input type="checkbox" aria-label="Foreing Related Party Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/RtIntSafeHavenRegsAFRInd"/>
									<xsl:with-param name="BackupName">RtIntSafeHavenRegsAFRIndYes</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						</div>
						...
						<span>
							...
							<input type="checkbox" aria-label="Foreing Related Party Indicator No" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/RtIntSafeHavenRegsAFRInd"/>
									<xsl:with-param name="BackupName">RtIntSafeHavenRegsAFRIndNo</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						</div>
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<span class="styLNDesc" style="width:167mm;">
							Did the filer issue a covered debt instrument in any of the transactions described in Regulations section 1.385-3(b)(2) with respect to the foreign corporation during the tax year, or, did the filer issue or refinance indebtedness owed to the foreign corporation during the 36 months before or after the date of a distribution or acquisition described in Regulations section 1.385-3(b)(3)(i) made by the filer,
						</span>
						<div class="styIRS5471YesNoBoxShadingCell" style="height:9mm;">
							</div>
						<div class="styIRS5471LFNoBoxShading" style="height:9mm;">
							</div>					
					</div>
					<div class="styGenericDiv" style="width:187mm">
						<span class="styLNDesc" style="width:167mm; margin-left:8mm;">  and either the issuance or refinance of indebtedness, or the distribution or acquisition, occurred during the tax year?
							<span class="styDotLn" style="float:right; padding-right:1mm;">....</span>
						</span>
						<div class="styIRS5471YesNoBox">
						<span>
					...
					<span class="styLNLeftNumBox" style="padding-left:3mm;">(1)</span>
						<span class="styLNDesc" style="width:167mm; ">
							<span style="float:left;padding-left:.5mm; ">The amount of such transaction(s), distribution(s), and acquisition(s) </span>
							<span class="styDotLn" style="float:left; padding-right:1mm;">............</span>
							<span style="padding-left:1mm">
								<!-- Ding Bat
								<img src="{$ImagePath}/5471_Bullet_Title.gif" alt="right pointing arrow"/>-->
							...
							<span style="width:1mm"/>$
							<span class="sty1120FItemUnderlineSM" style="width:25mm; border-bottom:2pt solid black;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/TransDistriAcquisitionsAmt"/>
								</xsl:call-template>
							</span>
						</span>
						<div class="styIRS5471YesNoBoxShadingCell">
					...
					<p style="page-break-before:always"/>
					<!--BEGIN Page 6 HEADER-->
					<div class="styBB" style="width:187mm; border-bottom: 2pt solid black;">
						<div style="float: left; clear: none">Form 5471 (Rev. 12-2025)</div>
						<div style="float:right">
					...
					<div class="styBB" style="width:187mm; border-top: 1px solid black;">
						<div class="styPartName" style="width: 22mm; float: left;">Schedule G</div>
						<div class="styPartDesc" style="width: 165mm;">
							<span style="width:16px; float: left;"/>Other Information (continued)</div>
					</div>
					<!--   END SCHEDULE G HEADER   -->
...
<!--						<span style="width: 7mm;"></span>-->
						...
						<span>						
							<xsl:call-template name="PopulateSpan">
								<xsl:with-param name="TargetNode" select="$IRS5471GData/PayOrAccrueTopUpTaxInd"/>
							</xsl:call-template>
							<input type="checkbox" aria-label="Pay or accrue any Top-up Tax Yes" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/PayOrAccrueTopUpTaxInd"/>
									<xsl:with-param name="BackupName">PayOrAccrueTopUpTaxIndYes</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						</div>
<!--						<span class="styNBSP" style="width: 10px"/>-->
						...
						<span>
							...
							<input type="checkbox" aria-label="Pay or accrue any Top-up Tax No" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/PayOrAccrueTopUpTaxInd"/>
									<xsl:with-param name="BackupName">PayOrAccrueTopUpTaxIndNo</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						</div>
					</div>					
					<!--   END LINE 20a of Schedule G   -->
					<!--   BEGIN LINE 20b of Schedule G  -->
					<div class="styGenericDiv" style="width:187mm;">
					<span class="styLNLeftNumBox" style="padding-left:5mm;">b</span>
						<span class="styLNDesc" style="width:167mm; ">
							<span style="float:left;padding-left:.5mm;">If the answer to question 20a is “Yes,” enter the amount of each type of tax paid or accrued. See instructions.</span>
						</span>
						<div class="styIRS5471YesNoBoxShadingCell">
							</div>
						<div class="styIRS5471LFNoBoxShading">
					...
					<!--   END LINE 20b of Schedule G   -->
					<!--   BEGIN LINE 20b1 of Schedule G  -->
					<div class="styGenericDiv" style="width:187mm;">
					<span class="styLNLeftNumBox" style="padding-left:3mm;">(1)</span>
						<span class="styLNDesc" style="width:167mm; ">
							<span style="float:left;padding-left:.5mm;">Income Inclusion Rule (IIR) (or similar taxes)</span>
							<span class="styDotLn" style="float:left; padding-right:1mm;">....................</span>
							<span style="width:1mm"/>$
							<span class="sty1120FItemUnderlineSM" style="width:25mm; border-bottom:2pt solid black;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/IIROrSimilarTaxesAmt"/>
								</xsl:call-template>
							</span>
						</span>
						<div class="styIRS5471YesNoBoxShadingCell">
					...
					<!--   BEGIN LINE 20b2 of Schedule G  -->
					<div class="styGenericDiv" style="width:187mm;">
					<span class="styLNLeftNumBox" style="padding-left:3mm;">(2)</span>
						<span class="styLNDesc" style="width:167mm; ">
							<span style="float:left;padding-left:.5mm;">Qualified Domestic Minimum Top-up Tax (QDMTT) (or similar taxes)</span>
							<span class="styDotLn" style="float:left; padding-right:1mm;">.............</span>
							<span style="width:1mm"/>$
							<span class="sty1120FItemUnderlineSM" style="width:25mm; border-bottom:2pt solid black;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/QDMTTOrSimilarTaxesAmt"/>
								</xsl:call-template>
							</span>
						</span>
						<div class="styIRS5471YesNoBoxShadingCell">
					...
					<!--   END LINE 20b2 of Schedule G   -->
					<!--   BEGIN LINE 20b3 of Schedule G  -->
					<!--<div class="styGenericDiv" style="width:187mm;height:8mm;border-bottom:2pt solid black;">-->
					<div class="styGenericDiv" style="width:187mm;height:4mm;">
					<span class="styLNLeftNumBox" style="padding-left:3mm;">(3)</span>
						<span class="styLNDesc" style="width:167mm; ">
							<span style="float:left;padding-left:.5mm;">UTPR (or similar taxes)</span>
							<span class="styDotLn" style="float:left; padding-right:1mm;">...........................</span>
							<span style="width:1mm"/>$
							<span class="sty1120FItemUnderlineSM" style="width:25mm; border-bottom:2pt solid black;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/UTPROrSimilarTaxesAmt"/>
								</xsl:call-template>
							</span>
						</span>
						<div class="styIRS5471YesNoBoxShadingCell">
					...
					<!--   END LINE 20b3 of Schedule G   -->

					<!--   BEGIN LINE 21a of Schedule G  -->
					<!--<span  style="width:175mm;height:3mm;"></span>-->
					<div class="styGenericDiv" style="width:187mm">
						<span class="styLNLeftNumBox">21a</span>
						<span class="styLNDesc" style="width:167mm;">
							During the tax year, was any portion of any increase or decrease to the earnings and profits of the foreign
corporation (including  
					...
					<div class="styGenericDiv" style="width:187mm">
						<span class="styLNDesc" style="width:167mm; margin-left:8mm;">previously taxed earnings and profits described in section 959) attributable to a transaction
described in section 304?
						...
						<span>
							<xsl:call-template name="PopulateSpan">
								<xsl:with-param name="TargetNode" select="$IRS5471GData/EarningsProfitsSect304Ind"/>
							</xsl:call-template>
							<input type="checkbox" aria-label="Safe Haven Rate Rules of Regulations Applicable Yes" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/EarningsProfitsSect304Ind"/>
									<xsl:with-param name="BackupName">EarningsProfitsSect304IndYes</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						</div>
						...
						<span>
							...
							<input type="checkbox" aria-label="Safe Haven Rate Rules of Regulations Applicable No" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/EarningsProfitsSect304Ind"/>
									<xsl:with-param name="BackupName">EarningsProfitsSect304IndNo</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						</div>
					...
					<!--   END LINE 21a of Schedule G   -->	
					<!--   BEGIN LINE 21b of Schedule G  -->
					<div class="styGenericDiv" style="width:187mm;height:8mm;">
					<span class="styLNLeftNumBox" style="padding-left:5mm;">b</span>
						<span class="styLNDesc" style="width:167mm; ">
							<span style="float:left;padding-left:.5mm;">If the answer to question 21a is “Yes,” provide the following in functional currency, reporting an increase as a
positive number and a decrease as a negative number.</span>
						</span>
						<div class="styIRS5471YesNoBoxShadingCell" style="height:8mm;">
							</div>
						<div class="styIRS5471LFNoBoxShading" style="height:8mm;">
					...
					<!--   END LINE 20b of Schedule G   -->
					<!--   BEGIN LINE 21b1 of Schedule G  -->
					<div class="styGenericDiv" style="width:187mm;">
					<span class="styLNLeftNumBox" style="padding-left:3mm;">(1)</span>
						<span class="styLNDesc" style="width:167mm; ">
							<span style="float:left;padding-left:.5mm;">The change in previously taxed earnings and profits described in section 959(c)(1) and (c)(2)</span>
							<span class="styDotLn" style="float:left; padding-right:1mm;">....</span>
							<span style="padding-left:1mm">								
							</span>
							<span style="width:1mm"/>
							<span class="sty1120FItemUnderlineSM" style="width:25mm;border-bottom:2pt solid black;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/PTEPAmt"/>
								</xsl:call-template>
							</span>
						</span>
						<div class="styIRS5471YesNoBoxShadingCell">
					...
					<!--   BEGIN LINE 21b2 of Schedule G  -->
					<div class="styGenericDiv" style="width:187mm;">
					<span class="styLNLeftNumBox" style="padding-left:3mm;">(2)</span>
						<span class="styLNDesc" style="width:167mm; ">
							<span style="float:left;padding-left:.5mm;">The change in other earnings and profits described in section 959(c)(3)</span>
							<span class="styDotLn" style="float:left; padding-right:1mm;">...........</span>
							<span style="padding-left:1mm">								
							</span>
							<span style="width:1mm"/>
							<span class="sty1120FItemUnderlineSM" style="width:25mm;border-bottom:2pt solid black;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/OtherEarningsProfitsAmt"/>
								</xsl:call-template>
							</span>
						</span>
						<div class="styIRS5471YesNoBoxShadingCell">
					...
					<xsl:if test="(not($IRS5471IData)) or (($Print = $Separated) and count($IRS5471IData) &gt; 1)">
						...
						<div style="width:187mm;">
							...
							<div style="float:right;">
								<div class="styLNRightNumBox" style="height:4mm;background-color:grey;border-bottom:0px;"></div>
								<div class="styLNAmountBox" style="width:33mm;height:4mm;background-color:grey;border-bottom:0px;">
								</div>
							</div>
						</div>
						<div style="width:187mm;">
						...
						<div style="width:187mm;">
							<div style="float:left;">
								...
								<div class="styLNDesc" style="padding-top:.5mm;padding-bottom:.5mm;">
									<span style="float:left;">Earnings invested in U.S. property (enter the result from Worksheet B) </span>
									<span class="styDotLn" style="float:right; padding-right:2mm;">...........</span>
								</div>
							</div>
							<div style="float:right;">
...
<!--						<div class="styIRS5471YesNoBox" style="font-size:8pt;">
							<span class="styLNDesc" style="font-size:8pt; width:170mm;"/>						
								<b>Yes</b>							
							<span style="width: 1mm"/>							
								<b>&#160;No</b>
						...
						<div class="styGenericDiv" style="width:187mm;">
							...
							<span style="height:4mm; text-align:center; ">
								<div class="styIRS5471YesNoBox">
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="IncomeBlockedInd"/>
									</xsl:call-template>
									<input type="checkbox" aria-label="Any Income of Foreign Corportation Blocked Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
											<xsl:call-template name="PopulateYesCheckbox">
												<xsl:with-param name="TargetNode" select="IncomeBlockedInd"/>
							...
							<span style="height:4mm; text-align:center; ">
								<div class="styIRS5471LFNoBox">
									...
									<input type="checkbox" aria-label="Any Income of Foreign Corportation Blocked Indicator No" class="styCkbox" style="width:3mm; height:3mm;">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="IncomeBlockedInd"/>
						...
						<div class="styGenericDiv" style="width:187mm;">
							...
							<span style="height:4mm; text-align:center; ">
								...
								<input type="checkbox" aria-label="Income Unblocked Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="IncomeUnblockedInd"/>
							...
							<span style="height:4mm; text-align:center; ">
								...
								<input type="checkbox" aria-label="Income Unblocked Indicator No" class="styCkbox" style="width:3mm; height:3mm;">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="IncomeUnblockedInd"/>
						...
						<div class="styGenericDiv" style="width: 187mm;">
							<span class="styLNDesc" style="width: 175mm;padding-left:8mm;">
					...
					<div class="styGenericDiv" style="width:187mm;height:4mm;">
						...
						<span class="styLNDesc" style="width:167mm; ">
							...
							<input type="checkbox" aria-label="Extraordinary Disposition Account Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="EDAccountInd"/>
							...
							<input type="checkbox" aria-label="Extraordinary Disposition Account Indicator No" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="EDAccountInd"/>
					...
					<xsl:if test="($Print != $Separated) or (($Print = $Separated) and (count($IRS5471IData) = 1))">
						<xsl:for-each select="$IRS5471IData">
							...
							<div class="styBB" style="width:187mm; float:none; clear:both;">
								...
								<div class="styGenericDiv" style="width: 187mm;">
									<span class="styLNDesc" style="width: 159mm;padding-left:8mm;">
										If the answer to either question is "Yes," attach an explanation.
									</span>
								</div>
								<!--   END Line 7b of Schedule I   -->
								...
								<div class="styGenericDiv" style="width:187mm;height:4mm;">
									...
									<span style="height:4mm;width:8mm; text-align:center; ">
										<xsl:call-template name="PopulateSpan">
											<xsl:with-param name="TargetNode" select="EDAccountInd"/>
										</xsl:call-template>
										<input type="checkbox" aria-label="Extraordinary Disposition Account Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
					...
					<!-- Start Separate Data for Line 1b(3) -->
					<xsl:if test="(($Print = $Separated) and (count($IRS5471Data/PrevForeignEntityIdGrp) &gt; 1))">
						<br/>
						<span class="styRepeatingDataTitle">
							<br/>Form 5471, Line 1b(3) - Previous reference ID number(s), if any (see instructions):
						</span>
						<table class="styDepTbl" style="font-size:7pt;">
							<tbody>
								<xsl:for-each select="$IRS5471Data/PrevForeignEntityIdGrp">
					...
					<!-- End Separate Data for Line 1b(3) -->
								...
								<tbody>
									...
									<tr class="styDepTblRow2">
										<td class="styDepTblCell" style="text-align:left; border-bottom-width:0px;" colspan="3">
											<div class="styIRS5471YesNoBox" style="width:181mm;height:4.2mm;padding-top:0.5mm;font-weight:bold">
										...
										<td class="styDepTblCell" style="text-align:left; border-bottom-width:0px;" colspan="3">
											...
											<div class="styGenericDiv" style="width:181mm;">
												...
												<span>
													...
													<input type="checkbox" aria-label="Income Blocked Indicator Yes" class="styCkbox" style="width:4mm;">
														<xsl:call-template name="PopulateYesCheckbox">
															<xsl:with-param name="TargetNode" select="IncomeBlockedInd"/>
												...
												<span>
													...
													<input type="checkbox" aria-label="Income Blocked Indicator No" class="styCkbox" style="width:4mm;">
														<xsl:call-template name="PopulateNoCheckbox">
															<xsl:with-param name="TargetNode" select="IncomeBlockedInd"/>
										...
										<td class="styDepTblCell" style="text-align:left; border-bottom-width:0px;" colspan="3">
											...
											<div class="styGenericDiv" style="width:181mm;">
												...
												<span>
													...
													<input type="checkbox" aria-label="Income Unblocked Indicator Yes" class="styCkbox" style="width:4mm;">
														<xsl:call-template name="PopulateYesCheckbox">
															<xsl:with-param name="TargetNode" select="IncomeUnblockedInd"/>
															<xsl:with-param name="BackupName">IncomeUnblockedIndYes</xsl:with-param>
														</xsl:call-template>
												...
												<span>
													...
													<input type="checkbox" aria-label="Income Unblocked Indicator No" class="styCkbox" style="width:4mm;">
														<xsl:call-template name="PopulateNoCheckbox">
															<xsl:with-param name="TargetNode" select="IncomeUnblockedInd"/>
															<xsl:with-param name="BackupName">IncomeUnblockedIndNo</xsl:with-param>
														</xsl:call-template>
											...
											<div class="styGenericDiv" style="width:180mm;">
												<span class="styLNDesc" style="width:160mm;padding-left:8mm;">
													If the answer to either question is "Yes," attach an explanation.
												</span>
											</div>
											<!--   END Line 7b of Schedule I   -->
										...
										<td class="styDepTblCell" style="text-align:left; border-bottom-width:0px;" colspan="3">
											...
											<div class="styGenericDiv" style="width:181mm;height:4mm;">
												...
												<span>
													...
													<input type="checkbox" aria-label="Extraordinary Disposition Account Indicator Yes" class="styCkbox" style="width:4mm;">
														<xsl:call-template name="PopulateYesCheckbox">
															<xsl:with-param name="TargetNode" select="EDAccountInd"/>
															<xsl:with-param name="BackupName">ExtraordinaryDispositionAccountIndYes</xsl:with-param>
														</xsl:call-template>
												...
												<span>
													...
													<input type="checkbox" aria-label="Extraordinary Disposition Account Indicator No" class="styCkbox" style="width:4mm;">
														<xsl:call-template name="PopulateNoCheckbox">
															<xsl:with-param name="TargetNode" select="EDAccountInd"/>
															<xsl:with-param name="BackupName">ExtraordinaryDispositionAccountIndNo</xsl:with-param>
														</xsl:call-template>
