				...
				<form name="Form8283">
					...
					<div style="width:187mm;">
						<div class="styFNBox" style="width:32mm;height:21mm;">
							...
							<div class="styAgency" style="width:30mm;padding-bottom:2mm;">(Rev. December 2025)
						...
						<div class="styTYBox" style="width:30mm;height:10.5mm">
							...
							<div style="font-size:7pt;text-align:left;">
								...
								<span style="font-family:Arial;font-size:9pt;font-weight:bold;">36</span>
							</div>
						</div>
						<!-- Name(s) & EIN Box  -->
...
originally reported, if different from above. <br/>
						...
						Check this box if a family pass-through entity made the noncash charitable contribution. See instructions  
							...
							<span>
								<xsl:call-template name="PopulateSpan">
									<xsl:with-param name="TargetNode" select="$Form8283Data/FamilyPassThroughEntityInd"/>
								</xsl:call-template>
								<input type="checkbox" aria-label="Family PassThrough Entity" class="styCkbox" name="Checkbox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$Form8283Data/FamilyPassThroughEntityInd"/>
										<xsl:with-param name="BackupName">Form8283DataFamilyPassThroughEntityInd</xsl:with-param>
									</xsl:call-template>
								</input>
							</span>
							<label>
					...
					<div style="width:187mm;" id="TPctn" class="styTableContainerNBB">
						...
						<!--<table cellspacing="0" summary="Part I Information on Donated Property" style="" name="TYTable" id="TYTable" class="styTable">-->
							<thead class="styTableThead">
								<tr>
									<th scope="col" class="styTableCell"
									 style="width:6mm;text-align:center;font-size:7pt;font-weight:bold;border-color:black;border-right:none;vertical-align:top;">1</th>
									<th scope="col" class="styTableCell" style="width:61mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;vertical-align:top;">
										<span style="font-size:7pt;"><b>(a)</b> Name and address of the donee organization</span>
									</th>
									<th scope="col" class="styTableCell" style="width:61mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;vertical-align:top;">
										<span style="font-size:7pt;"><b>(b)</b> if donated property is a vehicle (see instructions), 
											check the box. Also enter the vehicle identification number (unless Form 1098-C is attached)
										</span>
									</th>								
									<th scope="col" class="styTableCell" 
									style="width:60mm;text-align:center;font-size:7pt;border-color:black;border-right:none;font-weight:normal;vertical-align:top;">
										<span style="font-size:7pt;"><b>(c)</b> Description and condition of donated property  
							...
							<tfoot/>
							<tbody>
								<!-- If the Print parameter is not set to be Separated, or there are less elements than the container height (4), execute -->
								<xsl:if test="($Print !=$Separated) 
								or (count($Form8283Data/InformationOnDonatedProperty) &lt;= 4)">
									<xsl:for-each select="$Form8283Data/InformationOnDonatedProperty">
										<tr>
											...
											<td class="styTableCell" style="width:60mm;text-align:left;font-size:7pt;font-weight:normal;border-color:black;vertical-align: top;"> 
											  <span style="width:34mm"/>
											  	 <input type="checkbox"   aria-label="Donated Property Vehicle"  class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
	                                            ...
	                                            <td class="styTableCell" style="width:60mm;text-align:left;font-size:7pt;font-weight:normal;border-color:black;  border-right:none;vertical-align: top;">
													<xsl:call-template name="PopulateText">
								...
								<xsl:if test="(count($Form8283Data/InformationOnDonatedProperty)
								 &lt; 1)  or         (($Print = $Separated) 
								  and (count($Form8283Data/InformationOnDonatedProperty) &gt; 4))">
									<tr>
										...
										<!--  Insert additional data message if Print is set to separated and there are four or more elements -->
										<xsl:if test="($Print = $Separated)
										 and (count($Form8283Data/InformationOnDonatedProperty) &gt; 4)">
											<td class="styTableCell" style="width:60mm;text-align:left;font-size:7pt;font-weight:normal; border-color:black;">
										...
										<td class="styTableCell" style="width:60mm;padding-right:27mm;font-weight:bold;border-color:black;">
											<span class="styTableCellPad"/>
	                                        <input type="checkbox"   aria-label="Donated Property Vehicle A"  class="styCkbox" name="Checkbox">
	                                        	<xsl:call-template name="PopulateCheckbox">
								...
								and (count($Form8283Data/InformationOnDonatedProperty) &gt; 4)">
									<tr>
										...
										<td class="styTableCell" style="width:60mm;text-align:center;font-weight:bold;border-color:black;">
				                 		...
				                 		<td class="styTableCell" style="width:60mm;padding-right:27mm;font-weight:bold;border-color:black;">
											<span class="styTableCellPad"/>
											<input type="checkbox"  aria-label="Donated Property Vehicle B" class="styCkbox" name="Checkbox">
												<xsl:call-template name="PopulateCheckbox">
								 ...
								 and (count($Form8283Data/InformationOnDonatedProperty) &gt; 4)">
									<tr>
										...
										<td class="styTableCell" style="width:60mm;text-align:center;font-weight:bold;border-color:black;">
	                                 	...
	                                 	<td class="styTableCell"  style="width:60mm;padding-right:27mm;font-weight:bold;border-color:black;">
											<span class="styTableCellPad"/>
											<input type="checkbox" aria-label="Donated Property Vehicle C" class="styCkbox" name="Checkbox">
							                	<xsl:call-template name="PopulateCheckbox">
								 ...
								 and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
									<tr>
										...
										<td class="styTableCell" style="width:81mm;;padding-right:38mm;font-weight:bold;border-color:black;">
											<span class="styTableCellPad"/>
								<input type="checkbox" aria-label="Donated Property Vehicle D" class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
								 ...
								 and (count($Form8283Data/InformationOnDonatedProperty) &gt; 4)">
									<tr>
										...
										<td class="styTableCell" style="width:81mm;text-align:center;font-weight:bold;border-color:black;">
	                                 	...
	                                 	<td class="styTableCell" style="width:81mm;padding-right:27mm;font-weight:bold;border-color:black;">
											<span class="styTableCellPad"/>
										<input type="checkbox" aria-label="Donated Property Vehicle D" class="styCkbox" name="Checkbox">
							        	<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$Form8283Data/testD"/>
							...
							<tbody>
								...
								<xsl:if test="($Print !=$Separated)
								 or (count($Form8283Data/InformationOnDonatedProperty) &lt;= 4)">
									<xsl:for-each select="$Form8283Data/InformationOnDonatedProperty">
										<tr>
											<td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size: 7pt;font-weight:bold;border-color:black;vertical-align:top;">
												<xsl:choose>
													<xsl:when test="PropertyId">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="PropertyId"/>
											...
											<td class="styTableCell" style="float:none;width:28mm;text-align:center;font-size: 7pt;font-weight:normal;border-color:black;vertical-align:top;">
											...
											<td class="styTableCell" style="width:27mm;font-size: 7pt;font-weight:normal;border-color:black;vertical-align:top;">
												<span style="width:0.1mm;float:left;">
													<xsl:call-template name="SetFormLinkInline">
											...
											<td class="styTableCell" style="width:26mm;text-align:left;font-size: 7pt;font-weight:normal;border-color:black;vertical-align:top;">
											...
											<td class="styTableCell" style="width:36mm;text-align:right;font-size: 7pt;font-weight:normal;border-color:black;vertical-align:top;">
											...
											<td class="styTableCell" style="width:26mm;text-align:left;font-size: 7pt;font-weight:normal;border-color:black;border-right:none;vertical-align:top;">
												<xsl:call-template name="PopulateText">
								...
								<xsl:if test="count($Form8283Data/InformationOnDonatedProperty)
								 ...
								 and (count($Form8283Data/InformationOnDonatedProperty) &gt; 4)">
									<tr>
										...
										<td class="styTableCell" style="width:26mm;text-align:center;font-weight:bold;border-color:black;vertical-align:top;">
											<span class="styTableCellPad"/>
										</td>
										<td class="styTableCell" style="width:26mm;text-align:center;font-weight:bold;border-color:black;vertical-align:top;">
											<span class="styTableCellPad"/>
										...
										border-color:black;border-right:none;vertical-align:top;">
											<span class="styTableCellPad"/>
										</td>
									</tr>
								</xsl:if>
								<xsl:if test="count($Form8283Data/InformationOnDonatedProperty)
								 ...
								 and (count($Form8283Data/InformationOnDonatedProperty) &gt; 4)">
									<tr>
										...
										<td class="styTableCell" style="width:44mm;text-align:center;font-weight:bold;border-color:black;border-right:none;vertical-align:top;">
											<span class="styTableCellPad"/>
										</td>
									</tr>
								</xsl:if>
					...
					<div style="width=187mm;">
						...
						<span style="text-align:center;padding-top:.5mm;padding-bottom:.5mm;padding-left:2mm;">
							Check the box that describes the type of property donated.  See instructions for definitions.</span>
					</div>
					</div>
					...
					<div style="width:187mm;">
						...
						<!-- Line 2 a  -->			
						<span style="width:60mm;height:4.5mm;text-align:left;"><b>a </b>
							<input type="checkbox" aria-label="Art Worth At Least 20000 Dollars" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<!-- Line 2 d -->		
						<span style="width:60mm;height:4.5mm;text-align:left;"><b>d </b>
							<input type="checkbox" aria-label="Other Real Estate"  class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<!-- Line 2 i -->				
						<span style="width:60mm;height:4.5mm;text-align:left;"><b>i </b>
							<input type="checkbox" aria-label="Vehicle" class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<!-- Line 2 b -->
						<span style="width:5mm;"/>
						<span style="width:60mm;height:4.5mm;text-align:left;"><b>b </b>
							<input type="checkbox" aria-label="Qualified Conservation Contribution"  class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<!-- Line 2 e -->							
						<span style="width:60mm;height:4.5mm;text-align:left;"><b>e </b>
						 	<input type="checkbox"  aria-label="Equipment" class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<!-- Line 2 j -->
						<span style="width:60mm;height:4.5mm;text-align:left;"><b>j </b>
						<input type="checkbox" aria-label="Clothing and household items" class="styCkbox">
						<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;">
						...
						<!-- Line 2 b1 -->	
						<span style="width:50mm;height:4.5mm;text-align:left;"><b>b1</b> <span style="width:1mm"/>
							<input type="checkbox" aria-label="Certified historic structure" class="styCkbox" name="Checkbox"> 
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$Form8283Data/CertifiedHistoricStructureInd"/>
									<xsl:with-param name="BackupName">Form8283DataCertifiedHistoricStructureInd</xsl:with-param>
								</xsl:call-template>
							</input>
							<span style="width: 2mm;"/>
							<label>
								...
								</xsl:call-template>Certified historic structure
							</label>
						</span>	
						<!-- Line 2 f -->
						<span style="width:60mm;height:4.5mm;text-align:left;"><b>f </b><span style="width: 1mm;"/> 
							<input type="checkbox" aria-label="Securities" class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<!-- Line 2 k -->
						<span style="width:60mm;height:4.5mm;text-align:left;"><b>k</b>
						<input type="checkbox" aria-label="Digital assets" class="styCkbox" name="Checkbox">
						<xsl:call-template name="PopulateCheckbox">
							<xsl:with-param name="TargetNode" select="$Form8283Data/DigitalAssetsInd"/>
								<xsl:with-param name="BackupName">Form8283DataDigitalAssetsInd</xsl:with-param>
							</xsl:call-template>
							</input>
							<span style="width: 2mm;"/>
							<label>
								<xsl:call-template name="PopulateLabel">
									<xsl:with-param name="TargetNode" select="$Form8283Data/DigitalAssetsInd"/>
									<xsl:with-param name="BackupName">Form8283DataDigitalassetsInd</xsl:with-param>
								</xsl:call-template>Digital assets
                            </label>
						</span>	
						<!-- Line 2 nps, g, l  -->						
					<div style="width:187mm;">
						<span style="width:15mm;"/>						
						<!-- Line 2 nps -->				
						<span style="width:50mm;height:4.5mm;text-align:left;"> <b>NPS #</b><span style="width:1mm"/>
							<span style="width:10mm;border-bottom:1px solid black;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$Form8283Data/CertifiedHistoricStructureInd/@nationalParkServiceNum"/>
								</xsl:call-template>
							</span>
						</span>	
						<!-- Line 2 g  -->	
						<span style="width:60mm;height:4.5mm;text-align:left;"><b>g </b>
						 	<input type="checkbox"  aria-label="Collectibles" class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<!-- Line 2 l  -->	
						<span style="width:60mm;height:4.5mm;text-align:left;"><b>l </b>
							<input type="checkbox"  aria-label="Other" class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$Form8283Data/OtherInd"/>
									<xsl:with-param name="BackupName">Form8283DataOther</xsl:with-param>
								</xsl:call-template>
							</input>
							<span style="width: 2mm;"/>
							<label>
					...
					<div style="width:187mm;">
						<span style="width:5mm;"/>
						<!-- Line 2 c  -->						
						<span style="width:60mm;height:4.5mm;text-align:left;"><b>c </b>
							<input type="checkbox" aria-label="Art Worth Less Than 20000 Dollars" class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<!-- Line 2 h -->	
						<span style="width:60mm;height:4.5mm;text-align:left;"><b>h </b>
							<input type="checkbox" aria-label="Intellectual Property" class="styCkbox" name="Checkbox"> 
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;padding-bottom:0mm;padding-top:0mm;">
						...
						<table cellspacing="0" style="" class="styTable">
							<thead class="styTableThead">
								<tr>
									...
									style="width:77mm;text-align:center;font-size:7pt;border-color:black;border-top-width:1px;font-weight:normal;vertical-align:top;">
									...
									<th scope="col" class="styTableCell" 
									style="width:75mm;text-align:center;font-size:7pt;border-color:black;border-top-width:1px;font-weight:normal;vertical-align:top;">
										<b>(b)</b>
										<span style="width:1px;"/>
									...
									<th scope="col" class="styTableCell" style="width:35mm;text-align:center;font-size:7pt;border-color:black;border-right:none;
									border-top-width:1px;font-weight:normal;vertical-align:top;">
										<b>(c)</b>
								 ...
								 &lt;= 3)">
									<xsl:for-each select="$Form8283Data/PropertyInformation">
										<tr>
											...
											border-color:black;font-weight:bold;vertical-align:top;">
												<xsl:choose>
													<xsl:when test="PropertyId">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="PropertyId"/>
											...
											<td class="styTableCell" style="width:68mm;text-align:left;border-color:black;font-size:7pt;vertical-align:top;">
<!--												<div>
													<xsl:call-template name="SetFormLinkInline">
														<xsl:with-param name="TargetNode" select="$Form8283Data/PropertyInformation"/>
													</xsl:call-template>
											...
											<td class="styTableCell" style="width:75mm;text-align:left;border-color:black;font-size:7pt;vertical-align:top;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="DonatedPropertyPhysicalCondTxt"/>
												</xsl:call-template>
											</td>
											<td class="styTableCell" style="width:35mm;text-align:right;border-color:black;font-size:7pt;border-right:none;vertical-align:top;">
												<xsl:call-template name="PopulateAmount">
								 ...
								 &lt; 1 or         (($Print = $Separated)
								  and (count($Form8283Data/PropertyInformation) &gt; 3))">
									<tr>
										...
										<td class="styTableCell" style="width:70mm;text-align:center;border-color:black;font-size:7pt;vertical-align:top;">
											<span class="styTableCellPad"/>
										</td>
										<td class="styTableCell" style="width:40mm;text-align:center;border-color:black;font-size:7pt;border-right:none;vertical-align:top;">
											<span class="styTableCellPad"/>
										</td>
									</tr>
								</xsl:if>
								...
								and (count($Form8283Data/PropertyInformation) &gt; 3))">
									<tr>
										...
										<td class="styTableCell" style="width:68mm;text-align:center;border-color:black;font-size:7pt;vertical-align:top;">
											<span class="styTableCellPad"/>
										</td>
										<td class="styTableCell" style="width:70mm;text-align:center;border-color:black;font-size:7pt;vertical-align:top;">
											<span class="styTableCellPad"/>
					...
					<div style="width:187mm;">
						...
						<!--Table expand/collapse toggle button end-->
						<div class="styTableContainerForTP3ctn" style="height:auto;" id="TP3ctn">
							<xsl:call-template name="SetInitialState"/>
							<table cellspacing="0" class="styTable" style=" border-bottom: 0px;">
								<thead class="styTableThead">
									<tr>
										<th scope="col" rowspan="2" colspan="1" class="styTableCell" 
										style="width:7mm;background-color:lightgrey;border-right:1px solid black;border-bottom:1px solid black;vertical-align:top;">
											<span style="width:1mm;"/>
										</th>
										<th scope="col" rowspan="2" colspan="1" class="styTableCell"
										 style="width:23mm;text-align:center;font-size:7pt;border-color:black;left-margin:3mm;font-weight:normal;vertical-align:top;">
											<b>(d)</b>
											<span style="width:1mm;"/>Date acquired by donor (mo., yr.)</th>
										<th scope="col" rowspan="2" class="styTableCell" 
										style="width:27mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;vertical-align:top;">
											<b>(e)</b>
											<span style="width:1mm;"/>How acquired by donor</th>
										<th scope="col" rowspan="2" class="styTableCell" 
										style="width:30mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;vertical-align:top;">
											<b>(f)</b>
									...
									<tr>
										<th scope="col" class="styTableCell" style="width:35mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;vertical-align:top;">
											<b>(h)</b>
											<span style="width:1mm;"/> Qualified conservation contribution relevant basis (see instructions)</th>
										<th scope="col" class="styTableCell" style="width:35mm;text-align:center;font-size:7pt;border-color:black;border-right:none;font-weight:normal;vertical-align:top;">
											<b>(i)</b>
											<span style="width:1mm;"/>Amount claimed as a deduction (see instructions)
										</th>
									</tr>
								</thead>
								<tfoot/>
								<tbody>
									<xsl:if test="($Print != $Separated)
									 or (count($Form8283Data/PropertyInformation) &lt;= 3)">
										<xsl:for-each select="$Form8283Data/PropertyInformation">
											<tr>
												<td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size:7pt;border-color:black;font-weight:bold;vertical-align:top;">
													<xsl:choose>
														<xsl:when test="PropertyId">
															<xsl:call-template name="PopulateText">
																<xsl:with-param name="TargetNode" select="PropertyId"/>
												...
												<td class="styTableCell" style="width:23mm;text-align:center;font-size:7pt;border-color:black;vertical-align:top;">
													<xsl:choose>
												...
												<td class="styTableCell" style="text-align:center;width:27mm;font-size:7pt;border-color:black;vertical-align:top;">
												...
												<td class="styTableCell" style="width:35mm;text-align:right;font-size:7pt;border-color:black;vertical-align:top;">
												...
												<td class="styTableCell" style="width:30mm;text-align:right;font-size:7pt;border-color:black;vertical-align:top;">
													<xsl:call-template name="PopulateAmount">
												...
												<td class="styTableCell" style="width:35mm;text-align:right;font-size:7pt;border-color:black;border-right:none;vertical-align:top;">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="QlfyCnsvrContriRelevantBssAmt"/>
													</xsl:call-template>
												</td>
									...
									and (count($Form8283Data/PropertyInformation) &gt; 3))">
										<tr>
											...
											<td class="styTableCell" style="width:27mm;text-align:center;font-size:7pt;border-color:black;vertical-align:top;">
												<span class="styTableCellPad"/>
											</td>
											<td class="styTableCell" style="width:30mm;text-align:center;font-size:7pt;border-color:black;vertical-align:top;">
												<span class="styTableCellPad"/>
											</td>
											<td class="styTableCell" style="width:30mm;text-align:center;font-size:7pt;border-color:black;vertical-align:top;">
												<span class="styTableCellPad"/>
											</td>
											<td class="styTableCell" style="width:35mm;text-align:center;font-size:7pt;border-color:black;vertical-align:top;">
												<span class="styTableCellPad"/>
											</td>
											<td class="styTableCell" style="width:35mm;text-align:center;font-size:7pt;border-color:black;border-right:none;vertical-align:top;">
												<span class="styTableCellPad"/>
											</td>
										</tr>
									</xsl:if>
									...
									&lt; 2 or         (($Print = $Separated)
									 and (count($Form8283Data/PropertyInformation) &gt; 3))">
										<tr>
											...
											<td class="styTableCell" style="width:20mm;text-align:center;font-size:7pt;border-color:black;vertical-align:top;">
												<span class="styTableCellPad"/>
											</td>
											<td class="styTableCell" style="width:30mm;text-align:center;font-size:7pt;border-color:black;vertical-align:top;">
												<span class="styTableCellPad"/>
					...
					<div class="pageEnd" style="width:187mm;">
						...
						<div style="float:right;">
							<span style="width:10px;"/>  
							  Form <span class="styBoldText" style="font-size:8pt;">8283</span>  (Rev. 12-2025)
						</div>
					</div>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;float:none;">
						<div style="float:left;">Form 8283 (Rev. 12-2025)<span style="width:130mm;"/>
						</div>
					...
					<div style="width:187mm;height:auto;" id="TPXctn">
						...
						<table cellspacing="0" class="styIRS8283TableContainer" style="width:183mm;border-top:none;" name="TYTable3" id="TYTable3">
							...
							<xsl:if test="(not($Form8283Data/PropertyInformation)) 
							or (((count($Form8283Data/PropertyInformation) &gt; 5)
							 and ($Print = $Separated)))">
								<tr>
								...
								<tr>
											...
											<div class="styLNDesc" style="width:179mm;height:4mm;font-weight:normal;">
												...
												<div class="" style="float:right;">
													...
													<span style="width:32mm;border-bottom:1px solid black;padding-left:3mm;">
														<xsl:choose>
															<xsl:when 
															test="((count($Form8283Data/PropertyInformation)
									...
									<div class="styLNLeftLtrBox" style="height:7mm;border-bottom-width:0px;">c</div>
										...
										<div style="width:187mm;">
											...
											<div style="width:90mm;">
												<div class="styLNLeftLtrBox" style="height:7mm;border-left:1px solid black;">
													<span style="width:1mm;"/>
												</div>
												<div style="font-size:6pt;font-weight:normal;">
										...
										<div style="width:187mm;">
											...
											<div class="styLNDesc" style="width:175mm;height:4mm;font-weight:normal;">
										...
										<td colspan="7" class="styTableCell" style="width:187mm;text-align:left;font-size:7pt;border-right:none;height:auto;">
											...
											<div style="width:187mm;">
												...
												<div class="styLNDesc" style="width:179mm;height:4mm;font-weight:normal;">
													...
													<div class="styGenericDiv" style="padding-left:0mm;width:40mm;">
														<b>(1)</b>
														<span style="width:12px;"/>For this tax year
                                                  </div>
													<div class="" style="float:right;">
											...
											<div style="width:187mm;height:10mm;">
												<div style="width:90mm;">
													...
													<div style="font-size:6pt;font-weight:normal;height:auto;border-bottom:1px solid black;height:10mm;width:80mm;">
													Address (number, street, and room or suite no.)
													<br />
														<xsl:if test="OrganizationUSAddress!=''">												
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizationUSAddress/AddressLine1Txt"/>
														</xsl:call-template>
														<br/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizationUSAddress/AddressLine2Txt"/>
														</xsl:call-template>
													</xsl:if>
													<xsl:if test="OrganizationForeignAddress!=''">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizationForeignAddress/AddressLine1Txt"/>
														</xsl:call-template>
														<br/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizationForeignAddress/AddressLine2Txt"/>
														</xsl:call-template>
													</xsl:if>
													<!--/div-->
													</div>
...
<!--													<div class="styLNLeftLtrBox" style="height:10mm;">
													...
													<div style="font-size:6pt;font-weight:normal;width:95mm;border-bottom:1px solid black;height:10mm;">
													City or town, state, and ZIP code
													<br />
													<xsl:if test="OrganizationUSAddress">
														<xsl:call-template name="PopulateCityStateInfo">
															<xsl:with-param name="TargetNode" select="OrganizationUSAddress"/>
														</xsl:call-template>
													</xsl:if>
													<xsl:if test="OrganizationForeignAddress">
														<xsl:call-template name="PopulateCityStateInfo">
															<xsl:with-param name="TargetNode" select="''"/>
															<xsl:with-param name="ForeignAddressTargetNode" select="OrganizationForeignAddress"/>
														</xsl:call-template>
														<span style="width: 2mm"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizationForeignAddress/CountryCd"/>
														</xsl:call-template>
													</xsl:if>
													</div>
												</div>											
											...
											<div style="width:187mm;">
												<div class="styLNLeftLtrBox" style="height:4.5mm;">d</div>
												<div class="styLNDesc" style="width:98mm;height:4mm;font-weight:normal;">
...
<!--					<div style="width:187mm;"/>-->
					<div style="width:187mm;">
						<div style="float:left;">I declare that the following item(s) included in Section B, Part I above has to the best of my knowledge
						 and belief an appraised value of not more than $500 (per item). Enter identifying letter from Section B, Part I and describe the specific item. See instructions.</div>
...
<!--					<div style="width:187mm;"/>-->
					...
					<div style="width:187mm;">
					    ...
					    Sign Here</div>
						<div>
							<div class="styIRS8283SignatureBox" style="width:125mm;border-right-width:1px;padding-bottom:0px;padding-left: 1mm;border-bottom-width:1px;
							height:4mm;padding-top:0mm;font-size:7pt;">Appraiser signature  
							</div>
							<div class="styIRS8283SignatureBox" style="width:52mm;height:4mm;border-right-width:0px;padding-bottom:0px;padding-left: 1mm;border-bottom-width:1px;">   
								<span style="padding-right:1mm;border-bottom-width:1px;"> Date </span>
								<span style="width:1mm;"/>
								<xsl:call-template name="PopulateMonthDayYear">
						...
						<div>
							<div class="styIRS8283SignatureBox" style="width:100mm;border-right-width:1px;padding-bottom:0px;padding-left: 1mm;border-bottom-width:0px;
							height:4mm;padding-top:0mm;font-size:7pt;">Appraiser name       
							 <span style="width:1mm;"/>
								<xsl:call-template name="PopulateText">
							...
							<div class="styIRS8283SignatureBox" style="width:67mm;border-right-width:0px;padding-bottom:0px;padding-left: 1mm;border-bottom-width:0px;
							height:4mm;padding-top:0mm;font-size:7pt;">
								 Title 
								<span style="width:1mm;"/>
								<xsl:call-template name="PopulateText">
					...
					<div class="styBB" style="width:187mm;border-top-width:1px">
						<div class="styNameBox" style="font-family:Arial;font-size:7pt;width:187mm;height:6mm;border-right-width:0px;">
						...
						Does the organization intend to use the property for an unrelated use?
							...
							<div style="float:right;">
								...
								<span>
									...
									<input type="checkbox" aria-label="Use Property For Unrelated Use Yes" class="styCkbox" name="Checkbox">
								...
								<span>
									...
									<input type="checkbox" aria-label="Use Property For Unrelated Use No" class="styCkbox" name="Checkbox">
							...
							<table class="styDepTbl" style="width:187mm;" id="donatedPrptyInfo">
								<thead class="styTableThead">
									...
									<th scope="col" class="styDepTblCell" style="width:7mm;text-align:center;font-size:7pt;font-weight:bold;border-color:black;border-right:none;
									 border-right-width:0px;vertical-align:top;">1</th>
										<th scope="col" class="styDepTblCell" style="width:60mm;text-align:center;font-size:7pt;border-color:black;
										 font-weight:normal;border-left-width:0px;vertical-align:top;">
											<span class="styBoldText">(a)</span>
											<span style="width:1mm;"/>
											<span style="font-size:7pt;">
											Name and address of the donee organization</span>
										</th>
									<th scope="col" class="styDepTblCell" style="width:60mm;text-align:center;font-size:7pt;border-color:black; font-weight:normal;vertical-align:top;">
										...
										<th scope="col" class="styDepTblCell" style="width:60mm;text-align:center;font-size:7pt;border-color:black;border-right:none;font-weight:normal;vertical-align:top;">
								...
								<tbody>
									<xsl:for-each select="$Form8283Data/InformationOnDonatedProperty">
										<tr>
											...
											<td class="styTableCell" style="width:7mm;text-align:left;padding-left:3mm;font-size:7pt;font-weight:bold;border-color:black;vertical-align:top;">
												<xsl:choose>
													<xsl:when test="PropertyId">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="PropertyId"/>
						...
						<div>
							<table class="styDepTbl" style="width:187mm;" id="contDonPrptInfo">
								<thead class="styTableThead">
									...
									<tr class="styDepTblHdr">
										<th scope="col" class="styDepTblCell" style="width:7mm;background-color:lightgrey; border-right:1px solid black;border-bottom:1px solid black;vertical-align:top;">
											<span style="width:1mm;"/>
										</th>
										<th scope="col" class="styDepTblCell" style="width:26mm;text-align:center;font-size: 7pt;font-weight:normal;
										border-color:black;padding-top:3mm;vertical-align:top;">
											<span class="styBoldText">(d)</span>
											<span style="width:1mm;"/>Date of the contribution
                                       </th>
										<th scope="col" class="styDepTblCell" style="width:26mm;text-align:center;font-size: 7pt;font-weight:normal;border-color:black;vertical-align:top;">
											<span class="styBoldText">(e)</span>
											<span style="width:1mm;"/>Date acquired by donor (mo., yr.)
                                        </th>
										<th scope="col" class="styDepTblCell" style="width:26mm;text-align:center;font-size: 7pt;font-weight:normal;
								...
								<tbody>
									<xsl:for-each select="$Form8283Data/InformationOnDonatedProperty">
										<tr>
											...
											<td class="styTableCell" style="float:none;width:26mm;text-align:center;font-size: 7pt;font-weight:normal;border-color:black;vertical-align:top;">
												<span style="width:0.1mm;float:left;">
													<xsl:call-template name="LinkToLeftoverDataTableInline">
														<xsl:with-param name="Desc">
														Section A Part I Line 1 Columns (c) - (f) Donor line detail</xsl:with-param>
											...
											<td class="styTableCell" style="width:26mm;font-size: 7pt;font-weight:normal;border-color:black;vertical-align:top;">
												<span style="width:0.1mm;float:left;">
													<xsl:call-template name="SetFormLinkInline">
														<xsl:with-param name="TargetNode" select="DonorLineDetail/DonorAcquiredDt"/>
													</xsl:call-template>
											...
											font-size: 7pt;font-weight:normal;border-color:black;vertical-align:top;">
												<div class="styGenericDiv" style="text-align:left;">
													<xsl:call-template name="SetFormLinkInline">
														<xsl:with-param name="TargetNode" select="FairMarketValueAmt"/>
													</xsl:call-template>
											...
											<td class="styTableCell" style="width:30mm;text-align:left;
											 font-size: 7pt;font-weight:normal;border-color:black;border-right:none;vertical-align:top;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="FairMarketValueMethodDesc"/>
												</xsl:call-template>
											</td>
								...
								<tr>
									<td colspan="7" class="styTableCell" style="width:187mm;text-align:left;font-size:7pt;border-right:none;">
										...
										<div class="styDepTblRow1" style="width:187mm;">
											...
											<div class="styBB" style="width:180mm;margin-left:8mm;float:left;">
												<xsl:if test="OrganizationUSAddress">
													<xsl:if test="OrganizationUSAddress/AddressLine1Txt!=''">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizationUSAddress/AddressLine1Txt"/>
														</xsl:call-template>
													</xsl:if>
													<xsl:if test="OrganizationUSAddress/AddressLine2Txt!=''">
														<br/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizationUSAddress/AddressLine2Txt"/>
														</xsl:call-template>
												...
												<xsl:if test="OrganizationForeignAddress">
													<xsl:if test="OrganizationForeignAddress/AddressLine1Txt!=''">
														<br/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizationForeignAddress/AddressLine1Txt"/>
														</xsl:call-template>
													</xsl:if>
													<xsl:if test="OrganizationForeignAddress/AddressLine2Txt!=''">
														<br/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizationForeignAddress/AddressLine2Txt"/>
														</xsl:call-template>
										...
										<div class="styDepTblRow1" style="width:187mm;">
											...
											<div class="styBB" style="width:180mm;margin-left:8mm;float:left;">
												<xsl:if test="OrganizationUSAddress">
													<xsl:if test="OrganizationUSAddress/CityNm!=''">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizationUSAddress/CityNm"/>
														</xsl:call-template>,
													</xsl:if>
													<xsl:if test="OrganizationUSAddress/StateAbbreviationCd!=''">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizationUSAddress/StateAbbreviationCd"/>
														</xsl:call-template>
													</xsl:if>
													<xsl:if test="OrganizationUSAddress/ZIPCd!=''">
														<span style="width:1mm;"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizationUSAddress/ZIPCd"/>
														</xsl:call-template>
													</xsl:if>
												</xsl:if>
												<xsl:if test="OrganizationForeignAddress">
													<xsl:if test="OrganizationForeignAddress/CityNm!=''">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizationForeignAddress/CityNm"/>
														</xsl:call-template>,
													</xsl:if>
													<xsl:if test="OrganizationForeignAddress/ProvinceOrStateNm!=''">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizationForeignAddress/ProvinceOrStateNm"/>
														</xsl:call-template>
													</xsl:if>
													<xsl:if test="OrganizationForeignAddress/ForeignPostalCd!=''">
														<span style="width:1mm;"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizationForeignAddress/ForeignPostalCd"/>
														</xsl:call-template>
													</xsl:if>
													<xsl:if test="OrganizationForeignAddress/CountryCd!=''">
														<span style="width:1mm;"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizationForeignAddress/CountryCd"/>
														</xsl:call-template>
							...
							<table class="styDepTbl" style="width:187mm;">
								<thead class="styTableThead">
									<tr class="styDepTblHdr">
										...
										<th scope="col" class="styDepTblCell" style="width:75mm;text-align:center;font-size:7pt;border-color:black;
										border-top-width:1px;font-weight:normal;vertical-align:top;">
											<b>(b)</b>
											<span style="width:1px;"/>
										...
										<th scope="col" class="styDepTblCell" style="width:35mm;text-align:center;font-size:7pt;border-color:black;
										border-right:none;border-top-width:1px;font-weight:normal;vertical-align:top;">
											<b>(c)</b>
											<span style="width:1px;"/>Appraised fair market value</th>
									</tr>
								</thead>
							...
							<table class="styDepTbl" style="width:187mm;">
								<thead class="styTableThead">
									...
									<tr class="styDepTblHdr">
										...
										font-weight:normal;">
											<b>(h)</b>
											<span style="width:1mm;"/>Fair market value (see instructions) </th>
										<th scope="col" class="styDepTblCell" style="width:32mm;text-align:center;font-size:7pt;border-color:black;
										 border-right:none;font-weight:normal;">
											<b>(i)</b>
											<span style="width:1mm;"/>Amount claimed as a deduction (see instructions) </th>
									</tr>
								</thead>
								<tfoot/>
								<tbody>
