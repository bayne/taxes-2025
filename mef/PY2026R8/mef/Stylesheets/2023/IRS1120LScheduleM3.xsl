				...
				<form name="Form1120LScheduleM3">
					...
					<div class="styTBB" style="width:187mm;">
						<div class="styFNBox" style="width:31mm;height:21.5mm;border-right-width:2px;">
							...
							<span style="width:31mm;">(Rev. December 2021) 
								<!-- Form Link -->
						...
						<div class="styFTBox" style="width:125mm;height:21.5mm;">
							...
							<div class="styFST" style="height:5mm;padding-top:2mm;">
								 Attach to Form 1120-L.<br/>
						...
						<div style="width:30mm;height:21.5mm;" class="styTYBox">
							<div style="height:auto;padding-top:8mm;border-bottom-width:0px;" class="styOMB">
							  OMB No. 1545-0123
						</div>
					...
					<div style="width:187mm;font-size:6pt;">
						<div class="styGenericDiv" style="width:100mm;">
							...
							<input type="checkbox" aria-label="Non-consolidated return" class="styCkbox">
						...
						<div class="styGenericDiv" style="width:60mm;">
						 (2)
							<input type="checkbox" aria-label="Consolidated return (Form 1120-L only)" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div class="styBB" style="width:187mm;font-size:6pt;">
						<div class="styGenericDiv" style="width:100mm;">
							...
							<input type="checkbox" class="styCkbox" aria-label="Mixed 1120/L/PC group">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="width:60mm;">
						 (4)
							<input type="checkbox" class="styCkbox" aria-label="Dormant subsidiaries schedule attached">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" aria-label="CorporationFiledSECForm10KYes" class="styCkbox">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" aria-label="CorporationFiledSECForm10KNo" class="styCkbox">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" aria-label="CorpPrepCertAuditedIncomeStmtYes" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorpPrepCertAuditedIncmStmtInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" aria-label="CorpPrepCertAuditedIncomeStmtNo" class="styCkbox">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorpPrepCertAuditedIncmStmtInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" aria-label="CorporationPrepIncomeStatementYes" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationPreparedIncmStmtInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" aria-label="CorporationPrepIncomeStatementNo" class="styCkbox">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationPreparedIncmStmtInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" aria-label="CorporationIncomeStatementRestatedYes" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationIncmStmtRestatedInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" aria-label="CorporationIncomeStatementRestatedNo" class="styCkbox">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationIncmStmtRestatedInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" aria-label="CorpIncmStmtRestated5PrecedingYes" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorpIncmStmtRestated5PrecInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" aria-label="CorpIncmStmtRestated5PrecedingNo" class="styCkbox">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorpIncmStmtRestated5PrecInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" aria-label="CorporationVotingCommonStockPubTradedYes" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationVtngComStkPubTrdInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" aria-label="CorporationVotingCommonStockPubTradedNo" class="styCkbox">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationVtngComStkPubTrdInd"/>
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:135mm;padding-top:.5mm;">(1)
							    <input type="checkbox" aria-label="GAAP" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
								...
								<input type="checkbox" aria-label="IFRS" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
							    ...
							    <input type="checkbox" aria-label="Statutory" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
							    ...
							    <input type="checkbox" aria-label="Other (specify)" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
					...
					<div class="styTBB" style="width:187mm;"/>
					<!-- Page 1 Footer -->
					<div class="pageEnd" style="width:187mm;font-size:6.6pt">
						<div class="styBoldText" style="width:103mm;float:left;">For Paperwork Reduction Act Notice, see the Instructions for Form 1120-L.
						</div>
						<div style="width:25mm;float:left;">Cat. No. 39668S</div>
						<div class="styBoldText" style="float:right;">Schedule M-3 (Form 1120-L)  (Rev. 12-2021)</div>
					</div>
					<!-- Page 2 -->
					<!-- Page 2 Header -->
					...
					<div style="width:187mm;font-size:6pt;">
						<div class="styGenericDiv">
							...
							<input type="checkbox" aria-label="Consolidated group" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="padding-left:2mm;">
							<b>(2)</b>
							<input type="checkbox" aria-label="Parent corp" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="padding-left:2mm;">
							<b>(3)</b>
							<input type="checkbox" aria-label="Consolidated eliminations" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="padding-left:2mm;">
							<b>(4)</b>
							<input type="checkbox" aria-label="Subsidiary corp" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="padding-left:2mm;">
							<b>(5)</b>
							<input type="checkbox" aria-label="Mixed 1120/L/PC group" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;font-size:6pt;">
						<div class="styGenericDiv">
							...
							<b>(6)</b>
							<input type="checkbox" aria-label="1120-L group" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="padding-left:5mm;">
							<b>(7)</b>
							<input type="checkbox" aria-label="1120-L eliminations" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
...
<!-- Form Link -->
					...
					<div class="pageEnd" style="width:187mm;">
						<div class="styBoldText" style="float:right;padding-top:1mm;">Schedule M-3 (Form 1120-L)  (Rev. 12-2021)</div>
					</div>
					<!-- Page 3 -->
					<!-- Page 3 Header -->
					<div class="styTBB" style="width:187mm;float:none;">
