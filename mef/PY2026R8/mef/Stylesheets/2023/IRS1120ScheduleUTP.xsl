                ...
                Part I pages.
					...
					<div class="styBB" style="width:256mm;height:12mm;">
						...
						<div class="styPartDesc" style="width:225mm;font-weight:normal;font-size:7pt;">
							...
							<input aria-label="Part I - unable to obtain information from related parties sufficient to
...
(<span style="width:8px;"/>)(<span style="width:8px;"/>)(<span style="width:8px;"/>)(<span style="width:8px;"/>)
										...
										<td class="styIRS1120ScheduleUTP_styMiddleCell" style="padding-left:0;padding-right:0;font-size:6pt;width:23mm;">
											...
											(<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="RegulationSubSectionNum"/>
											</xsl:call-template>)
											(<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="RegulationSectionParNum"/>
											</xsl:call-template>)
											(<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="RegulationSectionSubParNum"/>
											</xsl:call-template>)
											(<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="RegulationSectionClauseNum"/>
											</xsl:call-template>)
										</td>
										<!-- End Part I Column (d) -->
										...
										<xsl:choose>
											<xsl:when test="BothTimingCodesInd">
												<td class="styIRS1120ScheduleUTP_styMiddleCell">
													...
													<input aria-label="Partl-Permanent" type="checkbox" class="styCkbox">
												...
												<td class="styIRS1120ScheduleUTP_styMiddleCell">
													<span style="width:4px;"/>
													<input aria-label="Partl-Temporary" type="checkbox" class="styCkbox">
														<xsl:call-template name="PopulateCheckbox">
															<xsl:with-param name="TargetNode" select="BothTimingCodesInd"/>
											...
											<xsl:otherwise>
												<td class="styIRS1120ScheduleUTP_styMiddleCell">
													<span style="width:4px;"/>
													<input aria-label="Partl-PermanentTimingCode" type="checkbox" class="styCkbox">
														<xsl:call-template name="PopulateCheckbox">
												...
												<td class="styIRS1120ScheduleUTP_styMiddleCell">
													<span style="width:4px;"/>
													<input aria-label="Partl-TemporaryTimingCode" type="checkbox" class="styCkbox">
														<xsl:call-template name="PopulateCheckbox">
										...
										<td class="styIRS1120ScheduleUTP_styMiddleCell">
											<span style="width:4px;"/>
											<input aria-label="Partl-MajorTaxPosition" type="checkbox" class="styCkbox">
												<xsl:call-template name="PopulateCheckbox">
                ...
                Part II pages.
					...
					<div class="styBB" style="width:256mm;height:12mm;">
						...
						<div class="styPartDesc" style="width:225mm;font-weight:normal;font-size:7pt;">
							...
							<span style="width: 6mm;"/>
							<input aria-label="Part II - unable to obtain information from related parties sufficient to
			 					determine whether a tax position is a UTP" type="checkbox" class="styCkboxNM" name="UnableObtainRelatedPartyInfoI">
								<xsl:call-template name="PopulateCheckbox">
...
(<span style="width:8px;"/>)(<span style="width:8px;"/>)(<span style="width:8px;"/>)(<span style="width:8px;"/>)
										...
										<xsl:choose>
											<xsl:when test="BothTimingCodesInd">
												<td class="styIRS1120ScheduleUTP_styMiddleCell">
													<span style="width:4px;"/>
													<input aria-label="Partll-Permanent" type="checkbox" class="styCkbox">
														<xsl:call-template name="PopulateYesCheckbox">
															<xsl:with-param name="TargetNode" select="BothTimingCodesInd"/>
												...
												<td class="styIRS1120ScheduleUTP_styMiddleCell">
													<span style="width:4px;"/>
													<input aria-label="Partll-Temporary" type="checkbox" class="styCkbox">
														<xsl:call-template name="PopulateCheckbox">
															<xsl:with-param name="TargetNode" select="BothTimingCodesInd"/>
											...
											<xsl:otherwise>
												<td class="styIRS1120ScheduleUTP_styMiddleCell">
													<span style="width:4px;"/>
													<input aria-label="Partll-PermanentTimingCode" type="checkbox" class="styCkbox">
														<xsl:call-template name="PopulateCheckbox">
															<xsl:with-param name="TargetNode" select="PermanentTimingCodeInd"/>
												...
												<td class="styIRS1120ScheduleUTP_styMiddleCell">
													<span style="width:4px;"/>
													<input aria-label="Partll-TemporaryTimingCode" type="checkbox" class="styCkbox">
														<xsl:call-template name="PopulateCheckbox">
															<xsl:with-param name="TargetNode" select="TemporaryTimingCodeInd"/>
										...
										<td class="styIRS1120ScheduleUTP_styMiddleCell">
											<span style="width:4px;"/>
											<input aria-label="Partll-MajorTaxPosition" type="checkbox" class="styCkbox">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="MajorTaxPositionInd"/>
							...
							<xsl:for-each select="$FormData/CurrentTYUTPInformationGrp">
								...
								<tr>
									...
									<xsl:choose>
										<xsl:when test="BothTimingCodesInd">
											<td class="styIRS1120ScheduleUTP_styMiddleCell" rowspan="2">
												<!--<span style="width:4px;"/>-->
												<input aria-label="BothTimingCodesInd" type="checkbox" class="styCkbox">
													<xsl:call-template name="PopulateYesCheckbox">
														<xsl:with-param name="TargetNode" select="BothTimingCodesInd"/>
										...
										<xsl:otherwise>
											<td class="styIRS1120ScheduleUTP_styMiddleCell" rowspan="2">
												<input aria-label="PermanentTimingCodeInd" type="checkbox" class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
														<xsl:with-param name="TargetNode" select="PermanentTimingCodeInd"/>
											...
											<td class="styIRS1120ScheduleUTP_styMiddleCell" rowspan="2">
												<input aria-label="TemporaryTimingCodeInd" type="checkbox" class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
														<xsl:with-param name="TargetNode" select="TemporaryTimingCodeInd"/>
									...
									<td class="styDepTblCell" rowspan="2">
										<input aria-label="MajorTaxPositionInd" type="checkbox" class="styCkbox">
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="MajorTaxPositionInd"/>
								...
								<tr>
									...
									<xsl:choose>
										<xsl:when test="BothTimingCodesInd">
											<td class="styIRS1120ScheduleUTP_styMiddleCell" rowspan="2">
												<span style="width:4px;"/>
												<input aria-label="Partll-BothTimingCodes" type="checkbox" class="styCkbox">
													<xsl:call-template name="PopulateYesCheckbox">
														<xsl:with-param name="TargetNode" select="BothTimingCodesInd"/>
	...
	<xsl:template name="PrintBlankTable1">
		...
		<xsl:if test="$numRows &gt; 0">
			<tr>
				...
				<td class="styIRS1120ScheduleUTP_styMiddleCell" rowspan="2">
					<span style="width:4px;"/>
					<input aria-label="Blank-PermanentTimingCode" type="checkbox" class="styCkbox">
						<xsl:call-template name="PopulateCheckbox">
							<xsl:with-param name="TargetNode" select="PermanentTimingCodeInd"/>
				...
				<td class="styIRS1120ScheduleUTP_styMiddleCell" rowspan="2">
					<span style="width:4px;"/>
					<input aria-label="Blank-TemporaryTimingCode" type="checkbox" class="styCkbox">
						<xsl:call-template name="PopulateCheckbox">
							<xsl:with-param name="TargetNode" select="TemporaryTimingCodeInd"/>
				...
				<td class="styIRS1120ScheduleUTP_styMiddleCell" rowspan="2">
					<span style="width:4px;"/>
					<input aria-label="Blank-MajorTaxPosition" type="checkbox" class="styCkbox">
						<xsl:call-template name="PopulateCheckbox">
							<xsl:with-param name="TargetNode" select="MajorTaxPositionInd"/>
	...
	<xsl:template name="PrintBlankTable2">
		...
		<xsl:if test="$numRows &gt; 0">
			<tr>
				...
				<td class="styIRS1120ScheduleUTP_styMiddleCell" rowspan="2">
					<span style="width:4px;"/>
					<input aria-label="Blank2-PermanentTimingCode" type="checkbox" class="styCkbox">
						<xsl:call-template name="PopulateCheckbox">
							<xsl:with-param name="TargetNode" select="PermanentTimingCodeInd"/>
				...
				<td class="styIRS1120ScheduleUTP_styMiddleCell" rowspan="2">
					<span style="width:4px;"/>
					<input aria-label="Blank2-TemporaryTimingCode" type="checkbox" class="styCkbox">
						<xsl:call-template name="PopulateCheckbox">
							<xsl:with-param name="TargetNode" select="TemporaryTimingCodeInd"/>
				...
				<td class="styIRS1120ScheduleUTP_styMiddleCell" rowspan="2">
					<span style="width:4px;"/>
					<input aria-label="Blank2-MajorTaxPosition" type="checkbox" class="styCkbox">
						<xsl:call-template name="PopulateCheckbox">
							<xsl:with-param name="TargetNode" select="MajorTaxPositionInd"/>
