		...
		<html lang="EN-US">
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			...
			<div class="styLNDesc" style="width:133mm;height:4.3mm;">
			  ...
			  <xsl:call-template name="LinkToLeftoverDataTableInline">
				<xsl:with-param name="Desc">Line 3 - Form 8978 Indicator</xsl:with-param>
			  ...
			  <input type="checkbox" aria-label="Member of a controlled group" class="styCkbox">
				<xsl:call-template name="PopulateCheckbox">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/MemberOfControlledGroupInd"/>
		  ...
		  <!-- line 8a -->
			...
			<!-- line 12a TotalIncreaseInTaxAmt -->
		  <div class="styGenericDiv" style="width:181mm;">
			<div style="width:141mm;float:left;clear:none;">
			  <div class="styLNLeftNumBoxSD" style="height:4.3mm;padding-left: 1mm;">12a</div>
			  <div class="styLNDesc" style="width:92mm;height:4.3mm;">
				<span style="float:left"> Recapture of investment credit (attach Form 4255)
                  <!-- Form to Form Link (Push Pin) -->
				  <xsl:call-template name="SetFormLinkInline">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/TotalIncreaseInTaxAmt"/>
				  </xsl:call-template>
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">....</div>
			  </div>
			  <div class="styLNRightNumBox" style="height:4.3mm;">12a</div>
			  <div class="styLNAmountBox" style="height:4.3mm;">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/TotalIncreaseInTaxAmt"/>
				</xsl:call-template>
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			<div style="width:141mm;float:left;clear:none;">
			  ...
			  <div class="styLNRightNumBox" style="height:4.3mm;">12b</div>
			  <div class="styLNAmountBox" style="height:4.3mm;">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/RecaptureTaxAmt"/>
				</xsl:call-template>
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			<div style="width:141mm;float:left;clear:none;">
			  ...
			  <div class="styLNRightNumBox" style="height:4.3mm;">12z</div>
			  <div class="styLNAmountBox" style="height:4.3mm;">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/OtherTaxesAmt"/>
				</xsl:call-template>
    		...
    		<!-- line 13 TotalOtherTaxesAndInterestAmt-->
			<div class="styGenericDiv" style="width:181mm;">
			  <div class="styLNLeftNumBox" style="height:4.3mm;">13</div>
			  <div class="styLNDesc" style="width:133mm;height:4.3mm;">
				<span style="float:left">  <b>Total.</b> Add lines 12a through 12z
                  <!-- Form to Form Link (Push Pin)-->
				  <xsl:call-template name="SetFormLinkInline">
			...
			<div class="styGenericDiv" style="width:181mm;">
				...
				<div class="styLNDesc" style="width:133mm;height:4.3mm;">
				<span style="float:left"><b>Total tax.</b> Add lines 9, 10, 11, and 13 
                  <!-- Form to Form Link (Push Pin) -->
				  <xsl:call-template name="SetFormLinkInline">
			...
			<!-- line 15a PriorYearOverpaymentCreditAmt-->
		  <div class="styGenericDiv" style="width:181mm;">
			<div style="width:141mm;float:left;clear:none;">
			  <div class="styLNLeftNumBoxSD" style="height:4.3mm;padding-left:1mm;">15a</div>
			...
			<!-- line 15b EstimatedTaxPaymentsAmt-->
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="width:141mm;float:left; clear:none;">
			...
			<!-- line 15C OverpaymentOfEstimatedTaxAmt-->
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="width:141mm;float:left;clear:none;">
				...
				<div class="styLNRightNumBox" style="height:4.3mm;">15c</div>
				<div class="styLNAmountBox" style="height:4.3mm;">
...
<!--			  <div style="width:40mm;float:left;clear:none;">
				...
				<div class="styLNAmountBoxNBB" style="height:4.3mm;width:32mm;background-color:lightgrey;"/>
			  	...
			  	<div style="width:40mm;float:right;clear:none;">   	       
					<div class="styLNRightNumBox" style="height:4.3mm;">15d</div>
					<div class="styLNAmountBox" style="height:4.3mm;">
					  <xsl:call-template name="PopulateAmount">
			...
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="width:141mm;float:left; clear:none;">
				  ...
				  <div class="styLNRightNumBox" style="height:4.3mm;">15e</div>
			...
			<!-- line 15f ReciprocalTaxPaidSect835dAmt -->
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="width:141mm;float:left;clear:none;">
				...
				<div class="styLNRightNumBox" style="height:4.3mm;">15f</div>
				<div class="styLNAmountBox" style="height:4.3mm;width:31.5mm;">
				  <xsl:call-template name="PopulateAmount">
			...
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="width:141mm;float:left;clear:none;">
				...
				<div class="styLNRightNumBox" style="height:4.3mm;">15g</div>
				<div class="styLNAmountBox" style="height:4.3mm;width:31.5mm;">
				  <xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/ElectivePaymentAmt"/>
				  </xsl:call-template>
			...
			<!-- line 15z OtherCreditsPaymentsAmt -->
			<div class="styGenericDiv"  style="width:181mm;">
			  <div style="width:141mm;float:left;clear:none;">
				...
				<div class="styLNRightNumBox" style="height:4.3mm;">15z</div>
				<div class="styLNAmountBox" style="height:4.3mm;width:31.5mm;">
				  <xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/OtherCreditsPaymentsAmt"/>
				  </xsl:call-template>
			...
			<!-- line 16 TotalPaymentsAndCreditsAmt -->
			<div style="width:181mm;border-bottom:1px solid black;">
			  <div style="float:left;clear:none;">
			  	<div class="styLNLeftNumBox" style="height:4.3mm;">16</div>
			  	<div class="styLNDesc" style="width:133mm;height:4.3mm;"><b>Total.</b> Combine lines 15d through 15z
					<!--Dotted Line-->
					<div class="styDotLn" style="float:right;">.....................</div> 
      	        </div> 
			  </div>
				<div style="width:40mm;float:right;clear:none;">
					<div class="styLNRightNumBox" style="height:4.3mm;width:8mm;border-bottom:0px solid black;">16</div>
...
-->				  <span style="width:2mm;"/>
			...
			<!-- line18 BalanceDueAmt -->
			<div class="styGenericDiv" style="width:181mm;">
			  <div class="styLNLeftNumBox" style="height:4.3mm;">18</div>
			  <div class="styLNDesc" style="width:133mm;height:4.3mm;">
				<span style="float:left"> <b>Amount owed.</b> If line 16 is smaller than the total of lines 14 and 17, enter amount owed
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">.....</div>
			  </div>
			...
			<!-- line19 OverpaymentAmt -->
			<div class="styGenericDiv" style="width:181mm;">
			  <div class="styLNLeftNumBox" style="height:4.3mm;">19</div>
			  <div class="styLNDesc" style="width:133mm;height:4.3mm;">
			    <span style="float:left"> <b>Overpayment.</b> If line 16 is larger than the total of lines 14 and 17, enter amount overpaid
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">....</div>
			  </div>
			...
			<!-- line 20 AppliedToEsTaxAmt -->
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="width:141mm;float:left;clear:none;">
				<div class="styLNLeftNumBox" style="height:4.3mm;">20</div>
				<div class="styLNDesc" style="width:79mm;height:4.3mm;">Enter amount from line 19: 
				  <span class="styBoldText">Credited to 2024 estimated tax</span><!--
				  <span style="width:2px"/>				  -->
				 <!-- <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="Small right pointing arrow"/>-->
				</div>
				<div class="styGenericDiv" style="width:36mm;height:4.3mm; padding-top:1mm;">
				  <xsl:call-template name="PopulateAmount">
...
<!--				  <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="Small right pointing arrow"/>-->
			  ...
			  <div style="width:40mm;float:right;clear:none;">
				<div class="styLNRightNumBoxNBB" style="height:4.3mm;">20</div>
...
-->									<span style="width:4px;"/>
              ...
              Form <span class="styBoldText" style="font-size:8pt;">1120-PC</span> (2023)
            </div>
					</div>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;float:none;">
						<div style="float:left;">Form 1120-PC (2023)<span style="width:146mm;"/>
						</div>
