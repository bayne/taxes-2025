        ...
        <span style="width: 18mm;border-bottom:1px solid black;">
          ...
          <span style="width: 18mm;border-bottom:1px solid black;">
			...
			<div class="styTYBox" style="width:30mm;height:18mm;">
			  ...
			  <div class="styTY" style="height:11mm;">20<span class="styTYColor">23</span></div>
			</div>
		  </div>
		  <!--Return Header End -->
		...
		<div class="styBB" style="width:187mm;border-bottom:2px solid black;border-top:1px solid black;">
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			...
			<div class="styLNDesc" style="width:133mm;height:4.3mm;">
			  ...
			  <xsl:call-template name="LinkToLeftoverDataTableInline">
				<xsl:with-param name="Desc">Line3 - Section 197 Amount</xsl:with-param>
...
<!--				  <span style="width:2mm;"/>-->
			...
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="width:141mm;float:left;clear:none;">
				...
				<div class="styGenericDiv" style="width:36mm;height:4.3mm; padding-top:0.5mm;">
				  <xsl:call-template name="PopulateAmount">
