	...
	<xsl:template match="/">
		...
		<html>
            ...
            <div class="styTYBox" style="width:30mm;height:18.5mm;">
              ...
              <div class="styTY" style="height:11mm;padding-top:2mm">20<span class="styTYColor">23</span>
              </div>
            </div>
          </div>
				<!--End header-->
					...
					<div class="styBB" style="width:187mm">
						...
						<div style="width:187mm;padding-top:3mm;">
							...
							<div class="sty1120FSchM3LNDesc">
								Has the corporation reported taxable income on Form 1120-F, page 5, using a treaty provision to attribute 
							...
							<div class="sty1120FSchM3ChkBx" style="width:16mm">
								<span>
									...
									<input type="checkbox" aria-label="Reported Income Under Rules Other Than Section 864c Yes" class="styCkbox">
							...
							<div class="sty1120FSchM3ChkBx" style=";width:16mm">
								<span>
									...
									<input type="checkbox" aria-label="Reported Income Under Rules Other Than Section 864c No"  class="styCkbox">
						...
						<div style="width:187mm;padding-top:0mm">
							...
							<div class="sty1120FSchM3ChkBx" style="width:16mm">
								<span>
									...
									<input type="checkbox" aria-label="Non Consolidated Certified Audited Income Statement Yes"  class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/NonCnsldtCertAudIncmStmtInd"/>
							...
							<div class="sty1120FSchM3ChkBx" style="width:16mm">
								<span>
									...
									<input type="checkbox" aria-label="Non Consolidated Certified Audited Income Statement No"  class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/NonCnsldtCertAudIncmStmtInd"/>
						...
						<div style="width:187mm;padding-top:0mm">
							...
							<div class="sty1120FSchM3ChkBx" style="width:16mm">
								<span>
									...
									<input type="checkbox" aria-label="Non Consolidated Worldwide Income Statement Yes" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/NonCnsldtWorldwideIncmStmtInd"/>
							...
							<div class="sty1120FSchM3ChkBx" style="width:16mm">
								<span>
									...
									<input type="checkbox" aria-label="Non Consolidated Worldwide Income Statement No" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/NonCnsldtWorldwideIncmStmtInd"/>
						...
						<div style="width:187mm;padding-top:0mm;padding-bottom:1mm">
							...
							<div class="sty1120FSchM3ChkBx" style="width:16mm">
								<span>
									...
									<input type="checkbox" aria-label="Certified Audited Income Statement Books Reported on 1120F Schedule L Yes" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/CertAudIncmStmtBksRptSchLInd"/>
							...
							<div class="sty1120FSchM3ChkBx" style="width:16mm">
								<span>
									...
									<input type="checkbox" aria-label="Certified Audited Income Statement Books Reported on 1120F Schedule L No" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/CertAudIncmStmtBksRptSchLInd"/>
					...
					<div class="styTBB" style="width:187mm">
						...
						<div style="width:187mm;padding-top:3mm;">
							...
							<div class="sty1120FSchM3LNDescLong" style="height:5mm">
								<span>
									...
									<input type="checkbox" aria-label="ForeignBankDefinedSect18825c4Yes" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/ForeignBankDefSect18825c4Ind"/>
							...
							<div class="sty1120FSchM3LNDescLong" style="height:5mm">
								<span>
									...
									<input type="checkbox" aria-label="ForeignBankDefinedSect18825c4No" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/ForeignBankDefSect18825c4Ind"/>
						...
						<div class="sty1120FSchM3LNDescLong">
							<span>
								...
								<input type="checkbox" aria-label="CorporationIncomeStatementRestated5PrecedingYes" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/CorpIncmStmtRestated5PrecInd"/>
						...
						<div class="sty1120FSchM3LNDescLong">
							<span>
								...
								<input type="checkbox" aria-label="CorporationIncomeStatementRestated5PrecedingNo" class="styCkbox">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/CorpIncmStmtRestated5PrecInd"/>
						...
						<div class="sty1120FSchM3LNDescLong">
							<span>
								...
								<input type="checkbox"  aria-label="CorporationStockPubliclyTradedYes" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/CorpStkPubliclyTradedInd"/>
						...
						<div class="sty1120FSchM3LNDescLong">
							<span>
								...
								<input type="checkbox" aria-label="CorporationStockPubliclyTradedNo"  class="styCkbox">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/CorpStkPubliclyTradedInd"/>
					...
					<div style="width:187mm;clear:both;padding-top:0.5mm">
						...
						<div style="float:right;" class="styGenericDiv">
							<b>Schedule M-3 (Form 1120-F) 2023</b>
						</div>
					</div>
					<br/>
					<div class="pageEnd"/>
					...
					<!--Page 2 Header-->
					<div class="styTBB" style="width:187mm">
					<div>Schedule M-3 (Form 1120-F) 2023</div>
							...
							<tbody>
								...
								<tr  style="border-bottom-width:1px">
									...
									<td colspan="6" style="font-size:7pt;border-bottom-width:10px;">
										...
										must equal Form 1120-F, page 5, line 29.
									</td>
								</tr>
							</tbody>
						</table>
